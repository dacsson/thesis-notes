# Source: SLPVectorizer/complex-loads.riscv64-unknown-linux-gnu__v_slp-vectorizer.ll
# Function: test
...
# %bb.0:                                # %entry
	...
	vadd.vv	v17, v8, v9
                                        # implicit-def: $v9
	vslidedown.vi	v9, v17, 2
	vslideup.vi	v9, v17, 2
                                        # implicit-def: $v10
	vrsub.vi	v10, v9, 0
                                        # implicit-def: $v0
	vsetivli	zero, 1, e8, mf8, tu, ma
	...
	vslideup.vi	v11, v8, 2
                                        # implicit-def: $v16
	vrsub.vi	v16, v11, 0
                                        # implicit-def: $v9
	vsetvli	zero, zero, e32, m1, tu, ma
	vmerge.vvm	v9, v11, v16, v0
                                        # implicit-def: $v19
	vsetvli	zero, zero, e32, m1, ta, ma
	vadd.vv	v19, v8, v9
                                        # implicit-def: $v8
	...
	vl1r.v	v0, (a0)                        # vscale x 8-byte Folded Reload
                                        # implicit-def: $v16
	vsetvli	zero, zero, e32, m1, ta, ma
	vslidedown.vi	v16, v11, 2
	vslideup.vi	v16, v11, 2
                                        # implicit-def: $v9
	vadd.vv	v9, v11, v16
                                        # implicit-def: $v8
	vsub.vv	v8, v11, v16
