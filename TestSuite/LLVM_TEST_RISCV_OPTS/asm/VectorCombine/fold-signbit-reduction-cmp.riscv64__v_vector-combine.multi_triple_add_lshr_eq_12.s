...
# Function: multi_triple_add_lshr_eq_12
# src = pre-opt (multi_triple_add_lshr_eq_12), tgt = post-opt (multi_triple_add_lshr_eq_12)
...
# %bb.0:
	...
	vmv1r.v	v10, v8
                                        ...
                                        # kill: def $v12 killed $v11 killed $vtype
