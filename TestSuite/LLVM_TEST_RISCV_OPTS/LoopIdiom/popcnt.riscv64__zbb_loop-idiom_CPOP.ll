...
; Variant: riscv64_+zbb_loop-idiom_CPOP
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-idiom -mtriple=riscv64 -mattr=+zbb -S
; Original: RUN: opt -passes=loop-idiom -mtriple=riscv64 -mattr=+zbb -S < %s | FileCheck %s --check-prefixes=CPOP
...
; ModuleID = '/tmp/tmpfkxxenmm.ll'
source_filename = "/tmp/tmpfkxxenmm.ll"
