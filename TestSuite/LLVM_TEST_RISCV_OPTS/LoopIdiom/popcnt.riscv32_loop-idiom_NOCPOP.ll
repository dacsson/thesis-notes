...
; Variant: riscv32_loop-idiom_NOCPOP
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-idiom -mtriple=riscv32 -S
; Original: RUN: opt -passes=loop-idiom -mtriple=riscv32 -S < %s | FileCheck %s --check-prefixes=NOCPOP
...
; ModuleID = '/tmp/tmppm7oqsa7.ll'
source_filename = "/tmp/tmppm7oqsa7.ll"
