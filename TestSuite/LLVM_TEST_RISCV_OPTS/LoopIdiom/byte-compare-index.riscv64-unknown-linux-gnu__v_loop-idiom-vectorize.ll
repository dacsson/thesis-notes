...
; Variant: riscv64-unknown-linux-gnu_+v_loop-idiom-vectorize
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-idiom-vectorize -mtriple=riscv64-unknown-linux-gnu -loop-idiom-vectorize-style=predicated -mattr=+v -S
; Original: RUN: opt -passes=loop-idiom-vectorize -mtriple=riscv64-unknown-linux-gnu -loop-idiom-vectorize-style=predicated -mattr=+v -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmp875k7e3q.ll'
source_filename = "/tmp/tmp875k7e3q.ll"
...
mismatch_vec_loop:                                ; preds = %mismatch_vec_loop_inc, %mismatch_vec_loop_preheader
  ...
  %15 = call i32 @llvm.experimental.get.vector.length.i64(i64 %avl, i32 16, i1 true)
  %16 = getelementptr i8, ptr %src1, i64 %mismatch_vector_index
  %lhs.load = call <vscale x 16 x i8> @llvm.vp.load.nxv16i8.p0(ptr %16, <vscale x 16 x i1> splat (i1 true), i32 %15)
  %17 = getelementptr i8, ptr %src2, i64 %mismatch_vector_index
  %rhs.load = call <vscale x 16 x i8> @llvm.vp.load.nxv16i8.p0(ptr %17, <vscale x 16 x i1> splat (i1 true), i32 %15)
  %mismatch.cmp = icmp ne <vscale x 16 x i8> %lhs.load, %rhs.load
  %18 = call i32 @llvm.vp.cttz.elts.i32.nxv16i1(<vscale x 16 x i1> %mismatch.cmp, i1 false, <vscale x 16 x i1> splat (i1 true), i32 %15)
