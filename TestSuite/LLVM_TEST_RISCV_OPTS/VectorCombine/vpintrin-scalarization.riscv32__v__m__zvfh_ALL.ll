...
; Variant: riscv32_+v,+m,+zvfh_ALL
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+v,+m,+zvfh -S
; Original: RUN: opt -S -mtriple=riscv32 -mattr=+v,+m,+zvfh %s | FileCheck %s --check-prefixes=ALL,NO-VEC-COMBINE
...
; ModuleID = '/tmp/tmplwdsc8lc.ll'
source_filename = "/tmp/tmplwdsc8lc.ll"
