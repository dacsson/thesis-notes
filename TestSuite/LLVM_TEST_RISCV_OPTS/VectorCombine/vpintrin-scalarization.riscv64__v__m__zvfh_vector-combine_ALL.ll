...
; Variant: riscv64_+v,+m,+zvfh_vector-combine_ALL
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+v,+m,+zvfh -passes=vector-combine -S
; Original: RUN: opt -S -mtriple=riscv64 -mattr=+v,+m,+zvfh %s -passes=vector-combine | FileCheck %s --check-prefixes=ALL,VEC-COMBINE,VEC-COMBINE-64
...
; ModuleID = '/tmp/tmp8qzopw0u.ll'
source_filename = "/tmp/tmp8qzopw0u.ll"
...
define <vscale x 1 x i64> @add_nxv1i64_allonesmask(<vscale x 1 x i64> %x, i64 %y, i32 zeroext %evl) #2 {
  ...
  %mask = shufflevector <vscale x 1 x i1> %splat, <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
  %1 = add i64 %y, 42
  %.splatinsert = insertelement <vscale x 1 x i64> poison, i64 %1, i64 0
  %2 = shufflevector <vscale x 1 x i64> %.splatinsert, <vscale x 1 x i64> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x i64> @llvm.vp.mul.nxv1i64(<vscale x 1 x i64> %x, <vscale x 1 x i64> %2, <vscale x 1 x i1> %mask, i32 %evl)
...
define <vscale x 1 x i64> @sdiv_nxv1i64_allonesmask_knownvl(i64 %x, i64 %y) #2 {
  ret <vscale x 1 x i64> splat (i64 1)
}
...
define <vscale x 1 x float> @fadd_nxv1f32_allonesmask(<vscale x 1 x float> %x, float %y, i32 zeroext %evl) #2 {
  %splat = insertelement <vscale x 1 x i1> poison, i1 true, i32 0
  %mask = shufflevector <vscale x 1 x i1> %splat, <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
  %1 = fadd float %y, 4.200000e+01
  %.splatinsert = insertelement <vscale x 1 x float> poison, float %1, i64 0
  %2 = shufflevector <vscale x 1 x float> %.splatinsert, <vscale x 1 x float> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x float> @llvm.vp.fadd.nxv1f32(<vscale x 1 x float> %x, <vscale x 1 x float> %2, <vscale x 1 x i1> %mask, i32 %evl)
...
define <vscale x 1 x float> @fdiv_nxv1f32_allonesmask_knownvl(<vscale x 1 x float> %x, float %y) #2 {
  ...
  %.splatinsert = insertelement <vscale x 1 x float> poison, float %1, i64 0
  %2 = shufflevector <vscale x 1 x float> %.splatinsert, <vscale x 1 x float> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x float> @llvm.vp.fadd.nxv1f32(<vscale x 1 x float> %x, <vscale x 1 x float> %2, <vscale x 1 x i1> %mask, i32 4)
  ret <vscale x 1 x float> %3
}
...
define <vscale x 1 x float> @copysign_nxv1f32_allonesmask(<vscale x 1 x float> %x, float %y, i32 zeroext %evl) #2 {
  %splat = insertelement <vscale x 1 x i1> poison, i1 true, i32 0
  %mask = shufflevector <vscale x 1 x i1> %splat, <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
  %1 = call float @llvm.copysign.f32(float %y, float 4.200000e+01)
  %.splatinsert = insertelement <vscale x 1 x float> poison, float %1, i64 0
  %2 = shufflevector <vscale x 1 x float> %.splatinsert, <vscale x 1 x float> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x float> @llvm.vp.fadd.nxv1f32(<vscale x 1 x float> %x, <vscale x 1 x float> %2, <vscale x 1 x i1> %mask, i32 %evl)
  ret <vscale x 1 x float> %3
...
define <vscale x 1 x float> @minnum_nxv1f32_allonesmask(<vscale x 1 x float> %x, float %y, i32 zeroext %evl) #2 {
  %splat = insertelement <vscale x 1 x i1> poison, i1 true, i32 0
  %mask = shufflevector <vscale x 1 x i1> %splat, <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
  %1 = call float @llvm.minnum.f32(float %y, float 4.200000e+01)
  %.splatinsert = insertelement <vscale x 1 x float> poison, float %1, i64 0
  %2 = shufflevector <vscale x 1 x float> %.splatinsert, <vscale x 1 x float> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x float> @llvm.vp.fadd.nxv1f32(<vscale x 1 x float> %x, <vscale x 1 x float> %2, <vscale x 1 x i1> %mask, i32 %evl)
  ret <vscale x 1 x float> %3
...
define <vscale x 1 x float> @maxnum_nxv1f32_allonesmask(<vscale x 1 x float> %x, float %y, i32 zeroext %evl) #2 {
  %splat = insertelement <vscale x 1 x i1> poison, i1 true, i32 0
  %mask = shufflevector <vscale x 1 x i1> %splat, <vscale x 1 x i1> poison, <vscale x 1 x i32> zeroinitializer
  %1 = call float @llvm.maxnum.f32(float %y, float 4.200000e+01)
  %.splatinsert = insertelement <vscale x 1 x float> poison, float %1, i64 0
  %2 = shufflevector <vscale x 1 x float> %.splatinsert, <vscale x 1 x float> poison, <vscale x 1 x i32> zeroinitializer
  %3 = call <vscale x 1 x float> @llvm.vp.fadd.nxv1f32(<vscale x 1 x float> %x, <vscale x 1 x float> %2, <vscale x 1 x i1> %mask, i32 %evl)
  ret <vscale x 1 x float> %3
...
define <vscale x 8 x i8> @add_nxv8i8_allonesmask(<vscale x 8 x i8> %x, i8 %y, i32 zeroext %evl) #2 {
  ...
  %mask = shufflevector <vscale x 8 x i1> %splat, <vscale x 8 x i1> poison, <vscale x 8 x i32> zeroinitializer
  %1 = add i8 %y, 42
  %.splatinsert = insertelement <vscale x 8 x i8> poison, i8 %1, i64 0
  %2 = shufflevector <vscale x 8 x i8> %.splatinsert, <vscale x 8 x i8> poison, <vscale x 8 x i32> zeroinitializer
  %3 = call <vscale x 8 x i8> @llvm.vp.mul.nxv8i8(<vscale x 8 x i8> %x, <vscale x 8 x i8> %2, <vscale x 8 x i1> %mask, i32 %evl)
...
define <vscale x 8 x half> @fadd_nxv1f16_allonesmask(<vscale x 8 x half> %x, half %y, i32 zeroext %evl) #2 {
  %splat = insertelement <vscale x 8 x i1> poison, i1 true, i32 0
  %mask = shufflevector <vscale x 8 x i1> %splat, <vscale x 8 x i1> poison, <vscale x 8 x i32> zeroinitializer
  %1 = fadd half %y, 4.200000e+01
  %.splatinsert = insertelement <vscale x 8 x half> poison, half %1, i64 0
  %2 = shufflevector <vscale x 8 x half> %.splatinsert, <vscale x 8 x half> poison, <vscale x 8 x i32> zeroinitializer
  %3 = call <vscale x 8 x half> @llvm.vp.fadd.nxv8f16(<vscale x 8 x half> %x, <vscale x 8 x half> %2, <vscale x 8 x i1> %mask, i32 %evl)
...
define <1 x i64> @add_v1i64_allonesmask(<1 x i64> %x, i64 %y, i32 zeroext %evl) #2 {
  ...
  %3 = call <1 x i64> @llvm.vp.mul.v1i64(<1 x i64> %x, <1 x i64> %2, <1 x i1> %mask, i32 %evl)
  ret <1 x i64> %3
}
...
define <4 x i64> @add_v4i64_allonesmask(<4 x i64> %x, i64 %y, i32 zeroext %evl) #2 {
  ...
  %mask = shufflevector <4 x i1> %splat, <4 x i1> poison, <4 x i32> zeroinitializer
  %1 = add i64 %y, 42
  %.splatinsert = insertelement <4 x i64> poison, i64 %1, i64 0
  %2 = shufflevector <4 x i64> %.splatinsert, <4 x i64> poison, <4 x i32> zeroinitializer
  %3 = call <4 x i64> @llvm.vp.mul.v4i64(<4 x i64> %x, <4 x i64> %2, <4 x i1> %mask, i32 %evl)
  ret <4 x i64> %3
}
