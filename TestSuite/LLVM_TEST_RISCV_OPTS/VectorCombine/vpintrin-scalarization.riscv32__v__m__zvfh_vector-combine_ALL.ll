...
; Variant: riscv32_+v,+m,+zvfh_vector-combine_ALL
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+v,+m,+zvfh -passes=vector-combine -S
; Original: RUN: opt -S -mtriple=riscv32 -mattr=+v,+m,+zvfh %s -passes=vector-combine | FileCheck %s --check-prefixes=ALL,VEC-COMBINE,VEC-COMBINE-32
...
; ModuleID = '/tmp/tmpwtebicc_.ll'
source_filename = "/tmp/tmpwtebicc_.ll"
