...
; Variant: riscv64_zbs_require<profile-summary>,function(codegenprepare)
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes='require<profile-summary>,function(codegenprepare)' -mtriple=riscv64 -mattr=zbs -S
; Original: RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=riscv64 -mattr=zbs %s  | FileCheck --check-prefixes=CHECK,ZBS %s
...
; ModuleID = '/tmp/tmpqyr5nk2h.ll'
source_filename = "/tmp/tmpqyr5nk2h.ll"
