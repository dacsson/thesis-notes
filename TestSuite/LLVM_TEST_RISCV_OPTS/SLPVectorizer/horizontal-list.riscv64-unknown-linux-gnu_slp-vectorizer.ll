; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/horizontal-list.ll
; Variant: riscv64-unknown-linux-gnu_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64-unknown-linux-gnu -mcpu=sifive-p670 -pass-remarks-output= -S
; Original: RUN: opt -passes=slp-vectorizer -S < %s -mtriple=riscv64-unknown-linux-gnu -mcpu=sifive-p670 -pass-remarks-output=%t| FileCheck %s
...
; ModuleID = '/tmp/tmpgn6cqwz4.ll'
source_filename = "/tmp/tmpgn6cqwz4.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-linux-gnu"

define float @test(ptr %x) #0 {
entry:
  %arrayidx = getelementptr inbounds float, ptr %x, i64 1
  %0 = load <16 x float>, ptr %arrayidx, align 4
  %arrayidx.16 = getelementptr inbounds float, ptr %x, i64 17
  %1 = load <8 x float>, ptr %arrayidx.16, align 4
  %arrayidx.24 = getelementptr inbounds float, ptr %x, i64 25
  %2 = load <4 x float>, ptr %arrayidx.24, align 4
  %arrayidx.28 = getelementptr inbounds float, ptr %x, i64 29
  %3 = load float, ptr %arrayidx.28, align 4
  %arrayidx.29 = getelementptr inbounds float, ptr %x, i64 30
  %4 = load float, ptr %arrayidx.29, align 4
  %5 = shufflevector <16 x float> %0, <16 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %rdx.op = fadd fast <8 x float> %5, %1
  %6 = shufflevector <8 x float> %rdx.op, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %7 = shufflevector <16 x float> %0, <16 x float> %6, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %8 = shufflevector <16 x float> %7, <16 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %rdx.op1 = fadd fast <4 x float> %8, %2
  %9 = shufflevector <4 x float> %rdx.op1, <4 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %10 = shufflevector <16 x float> %7, <16 x float> %9, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %11 = call fast float @llvm.vector.reduce.fadd.v16f32(float 0.000000e+00, <16 x float> %10)
  %op.rdx = fadd fast float %11, %3
  %op.rdx2 = fadd fast float %op.rdx, %4
  ret float %op.rdx2
}
