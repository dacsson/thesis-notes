...
; Variant: riscv64_+v,+zvl256b,+zvfh,+zvfbfmin_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+v,+zvl256b,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt < %s -passes=slp-vectorizer -mtriple=riscv64  -mattr=+v,+zvl256b,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S  | FileCheck %s --check-prefixes=CHECK,ZVFH,ZVFH256
...
; ModuleID = '/tmp/tmpgut5muj1.ll'
source_filename = "/tmp/tmpgut5muj1.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64"
...
define void @reduce_or_2() #0 {
  %1 = call i1 @llvm.vector.reduce.or.v16i1(<16 x i1> zeroinitializer)
...
attributes #0 = { "target-features"="+v,+zvl256b,+zvfh,+zvfbfmin" }
attributes #1 = { nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvl256b,+zvfh,+zvfbfmin" }
attributes #2 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvl256b,+zvfh,+zvfbfmin" }
