...
; Variant: riscv32_+v_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -slp-threshold=-19 -mattr=+v -mtriple riscv32 -S
; Original: RUN: opt -passes=slp-vectorizer -S -slp-threshold=-19 -mattr=+v -mtriple riscv32 < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpkbsh12d0.ll'
source_filename = "/tmp/tmpkbsh12d0.ll"
...
while.body.i.i:                                   ; preds = %while.body.i.i, %newFuncRoot
  %2 = phi <2 x ptr> [ %1, %newFuncRoot ], [ %72, %while.body.i.i ]
  ...
  %__last.addr.0.i.i.20 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.19, i32 -4
  %incdec.ptr2.i.i.20 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.19, i32 4
  %47 = load float, ptr %incdec.ptr2.i.i.20, align 4
  %48 = load float, ptr %__last.addr.0.i.i.20, align 4
  store float %48, ptr %incdec.ptr2.i.i.20, align 4
  store float %47, ptr %__last.addr.0.i.i.20, align 4
  %__last.addr.0.i.i.21 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.20, i32 -4
  %incdec.ptr2.i.i.21 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.20, i32 4
  %49 = load float, ptr %incdec.ptr2.i.i.21, align 4
  %50 = load float, ptr %__last.addr.0.i.i.21, align 4
  store float %50, ptr %incdec.ptr2.i.i.21, align 4
  store float %49, ptr %__last.addr.0.i.i.21, align 4
  %__last.addr.0.i.i.22 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.21, i32 -4
  %incdec.ptr2.i.i.22 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.21, i32 4
  %51 = load float, ptr %incdec.ptr2.i.i.22, align 4
  %52 = load float, ptr %__last.addr.0.i.i.22, align 4
  store float %52, ptr %incdec.ptr2.i.i.22, align 4
  store float %51, ptr %__last.addr.0.i.i.22, align 4
  %__last.addr.0.i.i.23 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.22, i32 -4
  %incdec.ptr2.i.i.23 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.22, i32 4
  %53 = load float, ptr %incdec.ptr2.i.i.23, align 4
  %54 = load float, ptr %__last.addr.0.i.i.23, align 4
  store float %54, ptr %incdec.ptr2.i.i.23, align 4
  store float %53, ptr %__last.addr.0.i.i.23, align 4
  %__last.addr.0.i.i.24 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.23, i32 -4
  %incdec.ptr2.i.i.24 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.23, i32 4
  %55 = load float, ptr %incdec.ptr2.i.i.24, align 4
  %56 = load float, ptr %__last.addr.0.i.i.24, align 4
  store float %56, ptr %incdec.ptr2.i.i.24, align 4
  store float %55, ptr %__last.addr.0.i.i.24, align 4
  %__last.addr.0.i.i.25 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.24, i32 -4
  %incdec.ptr2.i.i.25 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.24, i32 4
  %57 = load float, ptr %incdec.ptr2.i.i.25, align 4
  %58 = load float, ptr %__last.addr.0.i.i.25, align 4
  store float %58, ptr %incdec.ptr2.i.i.25, align 4
  store float %57, ptr %__last.addr.0.i.i.25, align 4
  %__last.addr.0.i.i.26 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.25, i32 -4
  %incdec.ptr2.i.i.26 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.25, i32 4
  %59 = load float, ptr %incdec.ptr2.i.i.26, align 4
  %60 = load float, ptr %__last.addr.0.i.i.26, align 4
  store float %60, ptr %incdec.ptr2.i.i.26, align 4
  store float %59, ptr %__last.addr.0.i.i.26, align 4
  %__last.addr.0.i.i.27 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.26, i32 -4
  %incdec.ptr2.i.i.27 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.26, i32 4
  %61 = load float, ptr %incdec.ptr2.i.i.27, align 4
  %62 = load float, ptr %__last.addr.0.i.i.27, align 4
  store float %62, ptr %incdec.ptr2.i.i.27, align 4
  store float %61, ptr %__last.addr.0.i.i.27, align 4
  %__last.addr.0.i.i.28 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.27, i32 -4
  %incdec.ptr2.i.i.28 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.27, i32 4
  %63 = load float, ptr %incdec.ptr2.i.i.28, align 4
  %64 = load float, ptr %__last.addr.0.i.i.28, align 4
  store float %64, ptr %incdec.ptr2.i.i.28, align 4
  store float %63, ptr %__last.addr.0.i.i.28, align 4
  %__last.addr.0.i.i.29 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.28, i32 -4
  %incdec.ptr2.i.i.29 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.28, i32 4
  %65 = load float, ptr %incdec.ptr2.i.i.29, align 4
  %66 = load float, ptr %__last.addr.0.i.i.29, align 4
  store float %66, ptr %incdec.ptr2.i.i.29, align 4
  store float %65, ptr %__last.addr.0.i.i.29, align 4
  %__last.addr.0.i.i.30 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.29, i32 -4
  %incdec.ptr2.i.i.30 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.29, i32 4
  %67 = load float, ptr %incdec.ptr2.i.i.30, align 4
  %68 = load float, ptr %__last.addr.0.i.i.30, align 4
  store float %68, ptr %incdec.ptr2.i.i.30, align 4
  store float %67, ptr %__last.addr.0.i.i.30, align 4
  %__last.addr.0.i.i.31 = getelementptr inbounds i8, ptr %__last.addr.0.i.i.30, i32 -4
  %69 = insertelement <2 x ptr> poison, ptr %incdec.ptr2.i.i.30, i32 0
  %70 = insertelement <2 x ptr> %69, ptr %__last.addr.0.i.i.30, i32 1
  %71 = getelementptr i8, <2 x ptr> %70, <2 x i32> <i32 4, i32 -4>
  %incdec.ptr2.i.i.31 = getelementptr inbounds nuw i8, ptr %incdec.ptr2.i.i.30, i32 4
  %cmp1.i.i.31 = icmp ult ptr %incdec.ptr2.i.i.31, %__last.addr.0.i.i.31
  %72 = shufflevector <2 x ptr> %71, <2 x ptr> poison, <2 x i32> <i32 1, i32 0>
  br i1 %cmp1.i.i.31, label %while.body.i.i, label %invoke.cont21.exitStub
