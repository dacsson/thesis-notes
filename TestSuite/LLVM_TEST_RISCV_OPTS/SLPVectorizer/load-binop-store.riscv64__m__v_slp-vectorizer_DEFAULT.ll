...
; Variant: riscv64_+m,+v_slp-vectorizer_DEFAULT
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+m,+v -S
; Original: RUN: opt < %s -passes=slp-vectorizer -mtriple=riscv64 -mattr=+m,+v -S | FileCheck %s --check-prefixes=DEFAULT
...
; ModuleID = '/tmp/tmphrhrzdk8.ll'
source_filename = "/tmp/tmphrhrzdk8.ll"
