; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/long-mask-split.ll
; Variant: riscv64-unknown-linux-gnu_+v
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64-unknown-linux-gnu -mattr=+v -S
; Original: RUN: opt -S -mtriple=riscv64-unknown-linux-gnu -mattr=+v < %s | FileCheck %s
...
; ModuleID = '/tmp/tmprryno7zq.ll'
source_filename = "/tmp/tmprryno7zq.ll"
