...
; Variant: riscv64_"+v,+zvfh"_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt --passes=slp-vectorizer --mtriple=riscv64 -mattr="+v,+zvfh" -S
; Original: RUN: opt --passes=slp-vectorizer --mtriple=riscv64 -mattr="+v,+zvfh" -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmp2feivf7z.ll'
source_filename = "/tmp/tmp2feivf7z.ll"
...
attributes #0 = { "target-features"="+v,+zvfh" }
attributes #1 = { nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvfh" }
