...
; Original: RUN: opt -passes=slp-vectorizer -S -mtriple=riscv64-unknown-linux-gnu -mattr=+v < %s | FileCheck %s --check-prefixes=CHECK,NO-ZVFHMIN-ZVFBFMIN
...
; ModuleID = '/tmp/tmpdigvj83j.ll'
source_filename = "/tmp/tmpdigvj83j.ll"
