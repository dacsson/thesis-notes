...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv32 -mattr=+v -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt -passes=slp-vectorizer -S < %s -mtriple=riscv32 -mattr=+v  -riscv-v-slp-max-vf=0 | FileCheck %s
...
; ModuleID = '/tmp/tmp4hwfimoo.ll'
source_filename = "/tmp/tmp4hwfimoo.ll"
