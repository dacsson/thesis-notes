; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/reductions.ll
; Variant: riscv64_+v,+zvl512b,+zvfh,+zvfbfmin_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+v,+zvl512b,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt < %s -passes=slp-vectorizer -mtriple=riscv64  -mattr=+v,+zvl512b,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S  | FileCheck %s --check-prefixes=CHECK,ZVFH,ZVFH512
...
; ModuleID = '/tmp/tmp21duzp_e.ll'
source_filename = "/tmp/tmp21duzp_e.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64"

%struct.buf = type { [8 x i8] }

define i64 @red_ld_2xi64(ptr %ptr) #0 {
entry:
  %ld0 = load i64, ptr %ptr, align 8
  %gep = getelementptr inbounds i64, ptr %ptr, i64 1
...
define i64 @red_ld_4xi64(ptr %ptr) #0 {
entry:
  %0 = load <4 x i64>, ptr %ptr, align 8
  %1 = call i64 @llvm.vector.reduce.add.v4i64(<4 x i64> %0)
  ret i64 %1
}

define i64 @red_ld_8xi64(ptr %ptr) #0 {
entry:
  %0 = load <8 x i64>, ptr %ptr, align 8
  %1 = call i64 @llvm.vector.reduce.add.v8i64(<8 x i64> %0)
  ret i64 %1
}

define i64 @red_ld_16xi64(ptr %ptr) #0 {
entry:
  %0 = load <16 x i64>, ptr %ptr, align 8
  %1 = call i64 @llvm.vector.reduce.add.v16i64(<16 x i64> %0)
  ret i64 %1
}

define i64 @red_strided_ld_16xi64(ptr %ptr) #0 {
entry:
  %0 = call <16 x i64> @llvm.experimental.vp.strided.load.v16i64.p0.i64(ptr align 8 %ptr, i64 16, <16 x i1> splat (i1 true), i32 16)
  %1 = call i64 @llvm.vector.reduce.add.v16i64(<16 x i64> %0)
  ret i64 %1
}

define i8 @reduce_and(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = xor <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.and.v8i8(<8 x i8> %2)
  %op.rdx = and i8 %3, 1
  ret i8 %op.rdx
}

define i8 @reduce_or_1(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = xor <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.or.v8i8(<8 x i8> %2)
  ret i8 %3
}

define void @reduce_or_2() #0 {
  %1 = shl i64 0, 0
  %2 = insertelement <32 x i64> <i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 poison, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 poison>, i64 %1, i32 15
  %3 = shufflevector <32 x i64> %2, <32 x i64> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 15, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30>
  %4 = icmp ult <32 x i64> %3, zeroinitializer
  %5 = call i1 @llvm.vector.reduce.or.v32i1(<32 x i1> %4)
...
define i8 @reduce_xor(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = and <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.xor.v8i8(<8 x i8> %2)
  %op.rdx = xor i8 %3, 1
  ret i8 %op.rdx
}

define i8 @reduce_add(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
...
define i8 @reduce_smin(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = and <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.smin.v8i8(<8 x i8> %2)
  ret i8 %3
}
...
define i8 @reduce_smax(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = and <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.smax.v8i8(<8 x i8> %2)
  ret i8 %3
}
...
define i8 @reduce_umax(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = and <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.umax.v8i8(<8 x i8> %2)
  ret i8 %3
}
...
define i8 @reduce_umin(ptr %a, ptr %b) #0 {
entry:
  %arrayidx = getelementptr inbounds %struct.buf, ptr %a, i64 0, i32 0, i64 0
  %arrayidx3 = getelementptr inbounds %struct.buf, ptr %b, i64 0, i32 0, i64 0
  %0 = load <8 x i8>, ptr %arrayidx, align 1
  %1 = load <8 x i8>, ptr %arrayidx3, align 1
  %2 = and <8 x i8> %1, %0
  %3 = call i8 @llvm.vector.reduce.umin.v8i8(<8 x i8> %2)
  ret i8 %3
}

define i64 @red_zext_ld_2xi64(ptr %ptr) #0 {
entry:
...
define i64 @red_zext_ld_4xi64(ptr %ptr) #0 {
entry:
  %0 = load <4 x i8>, ptr %ptr, align 1
...
define i64 @red_zext_ld_8xi64(ptr %ptr) #0 {
entry:
  %0 = load <8 x i8>, ptr %ptr, align 1
  %1 = zext <8 x i8> %0 to <8 x i64>
  %2 = call i64 @llvm.vector.reduce.add.v8i64(<8 x i64> %1)
  ret i64 %2
}

define i64 @red_zext_ld_16xi64(ptr %ptr) #0 {
entry:
  %0 = load <16 x i8>, ptr %ptr, align 1
  %1 = zext <16 x i8> %0 to <16 x i64>
...
define i32 @stride_sum_abs_diff(ptr %p, ptr %q, i64 %stride) #0 {
  ...
  %3 = load <2 x i32>, ptr %p.2, align 4
  %4 = load <2 x i32>, ptr %q.2, align 4
  %5 = shufflevector <2 x i32> %1, <2 x i32> %3, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %6 = shufflevector <2 x i32> %2, <2 x i32> %4, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = sub <4 x i32> %5, %6
  %8 = call <4 x i32> @llvm.abs.v4i32(<4 x i32> %7, i1 true)
  %9 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %8)
  ret i32 %9
}

define i32 @reduce_sum_2arrays_a(ptr noalias %p, ptr noalias %q) #0 {
entry:
  %0 = load <4 x i8>, ptr %p, align 1
  %1 = load <4 x i8>, ptr %q, align 1
  %2 = shufflevector <4 x i8> %0, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %3 = shufflevector <4 x i8> %1, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %4 = shufflevector <4 x i8> %0, <4 x i8> %1, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %5 = zext <8 x i8> %4 to <8 x i32>
  %6 = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %5)
  ret i32 %6
}

define i32 @reduce_sum_2arrays_b(ptr noalias noundef %x, ptr noalias %y) #0 {
entry:
...
define bfloat @fadd_4xbf16(ptr %p) #0 {
  %x0 = load bfloat, ptr %p, align 2
  %p1 = getelementptr bfloat, ptr %p, i32 1
  %x1 = load bfloat, ptr %p1, align 2
  %p2 = getelementptr bfloat, ptr %p, i32 2
  %x2 = load bfloat, ptr %p2, align 2
  %p3 = getelementptr bfloat, ptr %p, i32 3
  %x3 = load bfloat, ptr %p3, align 2
  %r0 = fadd fast bfloat %x0, %x1
  %r1 = fadd fast bfloat %r0, %x2
  %r2 = fadd fast bfloat %r1, %x3
  ret bfloat %r2
...
define bfloat @fmul_4xbf16(ptr %p) #0 {
  %x0 = load bfloat, ptr %p, align 2
  %p1 = getelementptr bfloat, ptr %p, i32 1
  %x1 = load bfloat, ptr %p1, align 2
  %p2 = getelementptr bfloat, ptr %p, i32 2
...
define half @fadd_4xf16(ptr %p) #0 {
  %1 = load <4 x half>, ptr %p, align 2
  %2 = call fast half @llvm.vector.reduce.fadd.v4f16(half 0.000000e+00, <4 x half> %1)
  ret half %2
}

define half @fmul_4xf16(ptr %p) #0 {
  %x0 = load half, ptr %p, align 2
  %p1 = getelementptr half, ptr %p, i32 1
  %x1 = load half, ptr %p1, align 2
  %p2 = getelementptr half, ptr %p, i32 2
  %x2 = load half, ptr %p2, align 2
  %p3 = getelementptr half, ptr %p, i32 3
  %x3 = load half, ptr %p3, align 2
  %r0 = fmul fast half %x0, %x1
  %r1 = fmul fast half %r0, %x2
  %r2 = fmul fast half %r1, %x3
  ret half %r2
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i64 @llvm.vector.reduce.add.v16i64(<16 x i64>) #3

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <16 x i64> @llvm.experimental.vp.strided.load.v16i64.p0.i64(ptr captures(none), i64, <16 x i1>, i32) #4

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.and.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.or.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i1 @llvm.vector.reduce.or.v32i1(<32 x i1>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.xor.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.add.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.smin.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.smax.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.umax.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.umin.v8i8(<8 x i8>) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i16 @llvm.vector.reduce.add.v4i16(<4 x i16>) #3
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare half @llvm.vector.reduce.fadd.v4f16(half, <4 x half>) #3

attributes #0 = { "target-features"="+v,+zvl512b,+zvfh,+zvfbfmin" }
attributes #1 = { nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvl512b,+zvfh,+zvfbfmin" }
attributes #2 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvl512b,+zvfh,+zvfbfmin" }
