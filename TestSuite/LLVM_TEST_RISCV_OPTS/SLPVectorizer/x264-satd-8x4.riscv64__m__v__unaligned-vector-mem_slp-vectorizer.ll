; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/x264-satd-8x4.ll
...
; ModuleID = '/tmp/tmpetf_w71x.ll'
source_filename = "/tmp/tmpetf_w71x.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64"

define i32 @x264_pixel_satd_8x4(ptr %pix1, i32 %i_pix1, ptr %pix2, i32 %i_pix2) #0 {
entry:
  %idx.ext = sext i32 %i_pix1 to i64
  %idx.ext63 = sext i32 %i_pix2 to i64
  %arrayidx3 = getelementptr inbounds nuw i8, ptr %pix1, i64 4
  %arrayidx5 = getelementptr inbounds nuw i8, ptr %pix2, i64 4
  %0 = mul i64 %idx.ext, 1
  %1 = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr align 1 %pix1, i64 %0, <4 x i1> splat (i1 true), i32 4)
  %2 = bitcast <4 x i32> %1 to <16 x i8>
  %3 = zext <16 x i8> %2 to <16 x i32>
  %4 = mul i64 %idx.ext63, 1
  %5 = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr align 1 %pix2, i64 %4, <4 x i1> splat (i1 true), i32 4)
  %6 = bitcast <4 x i32> %5 to <16 x i8>
  %7 = zext <16 x i8> %6 to <16 x i32>
  %8 = sub nsw <16 x i32> %3, %7
  %9 = mul i64 %idx.ext, 1
  %10 = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr align 1 %arrayidx3, i64 %9, <4 x i1> splat (i1 true), i32 4)
  %11 = bitcast <4 x i32> %10 to <16 x i8>
  %12 = zext <16 x i8> %11 to <16 x i32>
  %13 = mul i64 %idx.ext63, 1
  %14 = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr align 1 %arrayidx5, i64 %13, <4 x i1> splat (i1 true), i32 4)
  %15 = bitcast <4 x i32> %14 to <16 x i8>
  %16 = zext <16 x i8> %15 to <16 x i32>
  %17 = sub nsw <16 x i32> %12, %16
  %18 = shl nsw <16 x i32> %17, splat (i32 16)
  %19 = add nsw <16 x i32> %18, %8
  %20 = shufflevector <16 x i32> %19, <16 x i32> poison, <16 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6, i32 9, i32 8, i32 11, i32 10, i32 13, i32 12, i32 15, i32 14>
  %21 = add nsw <16 x i32> %20, %19
  %22 = sub nsw <16 x i32> %20, %19
  %23 = shufflevector <16 x i32> %21, <16 x i32> %22, <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 8, i32 25, i32 10, i32 27, i32 12, i32 29, i32 14, i32 31>
  %24 = shufflevector <16 x i32> %23, <16 x i32> poison, <16 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5, i32 10, i32 11, i32 8, i32 9, i32 14, i32 15, i32 12, i32 13>
  %25 = add nsw <16 x i32> %23, %24
  %26 = sub nsw <16 x i32> %23, %24
  %27 = shufflevector <16 x i32> %25, <16 x i32> %26, <16 x i32> <i32 16, i32 17, i32 2, i32 3, i32 20, i32 21, i32 6, i32 7, i32 24, i32 25, i32 10, i32 11, i32 28, i32 29, i32 14, i32 15>
  %28 = shufflevector <16 x i32> %27, <16 x i32> poison, <16 x i32> <i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15, i32 8, i32 9, i32 10, i32 11>
  %29 = sub nsw <16 x i32> %27, %28
  %30 = add nsw <16 x i32> %27, %28
  %31 = shufflevector <16 x i32> %29, <16 x i32> %30, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 20, i32 21, i32 22, i32 23, i32 8, i32 9, i32 10, i32 11, i32 28, i32 29, i32 30, i32 31>
  %32 = shufflevector <16 x i32> %31, <16 x i32> poison, <16 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %33 = add nsw <16 x i32> %31, %32
  %34 = sub nsw <16 x i32> %31, %32
  %35 = shufflevector <16 x i32> %33, <16 x i32> %34, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %36 = lshr <16 x i32> %35, splat (i32 15)
  %37 = and <16 x i32> %36, splat (i32 65537)
  %38 = mul nuw <16 x i32> %37, splat (i32 65535)
  %39 = add <16 x i32> %38, %35
  %40 = xor <16 x i32> %39, %38
  %41 = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %40)
  %conv118 = and i32 %41, 65535
  %shr = lshr i32 %41, 16
  %add119 = add nuw nsw i32 %conv118, %shr
  %shr120 = lshr i32 %add119, 1
  ret i32 %shr120
