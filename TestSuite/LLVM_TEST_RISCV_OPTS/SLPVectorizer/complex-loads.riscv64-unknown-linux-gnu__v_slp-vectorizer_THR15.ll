...
; Variant: riscv64-unknown-linux-gnu_+v_slp-vectorizer_THR15
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple riscv64-unknown-linux-gnu --passes=slp-vectorizer -mattr=+v -slp-threshold=-15 -S
; Original: RUN: opt -S -mtriple riscv64-unknown-linux-gnu < %s --passes=slp-vectorizer -mattr=+v -slp-threshold=-15 | FileCheck %s --check-prefix=THR15
...
; ModuleID = '/tmp/tmp5of1osip.ll'
source_filename = "/tmp/tmp5of1osip.ll"
...
entry:
  ...
  %1 = load <4 x i8>, ptr %pix1, align 1
  %2 = zext <4 x i8> %1 to <4 x i32>
  %3 = load <4 x i8>, ptr %pix2, align 1
  %4 = zext <4 x i8> %3 to <4 x i32>
  %5 = sub <4 x i32> %2, %4
  %6 = load <4 x i8>, ptr %arrayidx3, align 1
  %7 = zext <4 x i8> %6 to <4 x i32>
  %8 = load <4 x i8>, ptr %arrayidx5, align 1
  %9 = zext <4 x i8> %8 to <4 x i32>
  %10 = sub <4 x i32> %7, %9
  %11 = shl <4 x i32> %10, splat (i32 16)
  %12 = add <4 x i32> %11, %5
  %13 = shufflevector <4 x i32> %12, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %14 = add <4 x i32> %13, %12
  %15 = sub <4 x i32> %13, %12
  %16 = shufflevector <4 x i32> %14, <4 x i32> %15, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %17 = shufflevector <4 x i32> %16, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %18 = add <4 x i32> %16, %17
  %19 = sub <4 x i32> %16, %17
  %20 = shufflevector <4 x i32> %18, <4 x i32> %19, <4 x i32> <i32 4, i32 5, i32 2, i32 3>
  %21 = load <4 x i8>, ptr %add.ptr3, align 1
  %22 = zext <4 x i8> %21 to <4 x i32>
  %23 = load <4 x i8>, ptr %add.ptr644, align 1
  %24 = zext <4 x i8> %23 to <4 x i32>
  %25 = sub <4 x i32> %22, %24
  %26 = load <4 x i8>, ptr %arrayidx3.1, align 1
  %27 = zext <4 x i8> %26 to <4 x i32>
  %28 = load <4 x i8>, ptr %arrayidx5.1, align 1
  %29 = zext <4 x i8> %28 to <4 x i32>
  %30 = sub <4 x i32> %27, %29
  %31 = shl <4 x i32> %30, splat (i32 16)
  %32 = add <4 x i32> %31, %25
  %33 = shufflevector <4 x i32> %32, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %34 = add <4 x i32> %33, %32
  %35 = sub <4 x i32> %33, %32
  %36 = shufflevector <4 x i32> %34, <4 x i32> %35, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %37 = shufflevector <4 x i32> %36, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %38 = add <4 x i32> %36, %37
  %39 = sub <4 x i32> %36, %37
  %40 = shufflevector <4 x i32> %38, <4 x i32> %39, <4 x i32> <i32 4, i32 5, i32 2, i32 3>
  %41 = load <4 x i8>, ptr %add.ptr.1, align 1
  %42 = zext <4 x i8> %41 to <4 x i32>
  %43 = load <4 x i8>, ptr %add.ptr64.1, align 1
  %44 = zext <4 x i8> %43 to <4 x i32>
  %45 = sub <4 x i32> %42, %44
  %46 = load <4 x i8>, ptr %arrayidx3.2, align 1
  %47 = zext <4 x i8> %46 to <4 x i32>
  %48 = load <4 x i8>, ptr %arrayidx5.2, align 1
  %49 = zext <4 x i8> %48 to <4 x i32>
  %50 = sub <4 x i32> %47, %49
  %51 = shl <4 x i32> %50, splat (i32 16)
  %52 = add <4 x i32> %51, %45
  %53 = shufflevector <4 x i32> %52, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %54 = add <4 x i32> %53, %52
  %55 = sub <4 x i32> %53, %52
  %56 = shufflevector <4 x i32> %54, <4 x i32> %55, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %57 = shufflevector <4 x i32> %56, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %58 = add <4 x i32> %56, %57
  %59 = sub <4 x i32> %56, %57
  %60 = shufflevector <4 x i32> %58, <4 x i32> %59, <4 x i32> <i32 2, i32 3, i32 4, i32 5>
  %61 = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 4, <2 x i1> splat (i1 true), i32 2)
  ...
  %68 = shufflevector <2 x i8> %0, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %69 = shufflevector <2 x i8> %61, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %70 = shufflevector <4 x i8> %68, <4 x i8> %69, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %71 = zext <4 x i8> %70 to <4 x i32>
  %72 = load <4 x i8>, ptr %arrayidx5.3, align 1
  %73 = zext <4 x i8> %72 to <4 x i32>
  %74 = shufflevector <4 x i32> %73, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %75 = sub <4 x i32> %71, %74
  %76 = shl <4 x i32> %75, splat (i32 16)
  %77 = add <4 x i32> %76, %67
  %78 = shufflevector <4 x i32> %77, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %79 = add <4 x i32> %77, %78
  %80 = sub <4 x i32> %77, %78
  %81 = shufflevector <4 x i32> %79, <4 x i32> %80, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %82 = shufflevector <4 x i32> %81, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %83 = add <4 x i32> %81, %82
  %84 = sub <4 x i32> %81, %82
  %85 = shufflevector <4 x i32> %83, <4 x i32> %84, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %86 = shufflevector <4 x i32> %40, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %87 = shufflevector <4 x i32> %20, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %88 = add <4 x i32> %86, %87
  %89 = sub <4 x i32> %20, %40
  %90 = shufflevector <4 x i32> %89, <4 x i32> %88, <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 4, i32 5, i32 6, i32 7>
  %91 = add <4 x i32> %85, %60
  %92 = sub <4 x i32> %60, %85
  %93 = shufflevector <4 x i32> %92, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %94 = shufflevector <4 x i32> %91, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %95 = shufflevector <8 x i32> %93, <8 x i32> %94, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %96 = add <8 x i32> %95, %90
  %97 = sub <8 x i32> %90, %95
  %98 = shufflevector <8 x i32> %96, <8 x i32> %97, <16 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7, i32 12, i32 8, i32 13, i32 9, i32 14, i32 10, i32 15, i32 11>
  %99 = shufflevector <4 x i32> %56, <4 x i32> %63, <16 x i32> <i32 2, i32 4, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %100 = shufflevector <4 x i32> %42, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %101 = shufflevector <16 x i32> %99, <16 x i32> %100, <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %102 = shufflevector <4 x i32> %22, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %103 = shufflevector <16 x i32> %101, <16 x i32> %102, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 18, i32 poison, i32 poison, i32 poison>
  %104 = shufflevector <4 x i32> %2, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %105 = shufflevector <16 x i32> %103, <16 x i32> %104, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 12, i32 poison, i32 18, i32 19>
  %106 = shufflevector <4 x i32> %36, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %107 = shufflevector <16 x i32> %105, <16 x i32> %106, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 18, i32 poison, i32 19, i32 poison, i32 12, i32 poison, i32 14, i32 15>
  %108 = shufflevector <4 x i32> %16, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %109 = shufflevector <16 x i32> %107, <16 x i32> %108, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 18, i32 10, i32 19, i32 12, i32 16, i32 14, i32 15>
  %110 = lshr <16 x i32> %109, splat (i32 15)
  %111 = and <16 x i32> %110, splat (i32 65537)
  %112 = mul <16 x i32> %111, splat (i32 65535)
  %113 = add <16 x i32> %112, %98
  %114 = xor <16 x i32> %113, %109
  %115 = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %114)
  ret i32 %115
}
...
declare <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr>, <2 x i1>, <2 x i8>) #3
