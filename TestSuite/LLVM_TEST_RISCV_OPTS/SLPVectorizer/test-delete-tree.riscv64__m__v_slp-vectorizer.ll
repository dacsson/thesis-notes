; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/test-delete-tree.ll
; Variant: riscv64_+m,+v_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+m,+v -passes=slp-vectorizer -S
; Original: RUN: opt -mtriple=riscv64 -mattr=+m,+v -passes=slp-vectorizer -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpo898ejfj.ll'
source_filename = "/tmp/tmpo898ejfj.ll"
