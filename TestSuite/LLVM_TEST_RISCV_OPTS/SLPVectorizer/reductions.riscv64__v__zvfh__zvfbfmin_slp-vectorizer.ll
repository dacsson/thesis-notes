...
; Variant: riscv64_+v,+zvfh,+zvfbfmin_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+v,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt < %s -passes=slp-vectorizer -mtriple=riscv64  -mattr=+v,+zvfh,+zvfbfmin -riscv-v-slp-max-vf=0 -S  | FileCheck %s --check-prefixes=CHECK,ZVFH,ZVFHDEFAULT
...
; ModuleID = '/tmp/tmpw8pvpprx.ll'
source_filename = "/tmp/tmpw8pvpprx.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64"
...
define void @reduce_or_2() #0 {
  %1 = shl i64 0, 0
  %2 = insertelement <16 x i64> <i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 poison>, i64 %1, i32 15
  %3 = icmp ult <16 x i64> %2, zeroinitializer
  %4 = insertelement <16 x i64> <i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 poison, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0>, i64 %1, i32 6
  %5 = icmp ult <16 x i64> %4, zeroinitializer
  %rdx.op = or <16 x i1> %3, %5
  %6 = call i1 @llvm.vector.reduce.or.v16i1(<16 x i1> %rdx.op)
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i1 @llvm.vector.reduce.or.v16i1(<16 x i1>) #3
...
attributes #0 = { "target-features"="+v,+zvfh,+zvfbfmin" }
attributes #1 = { nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvfh,+zvfbfmin" }
attributes #2 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvfh,+zvfbfmin" }
