...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple riscv64-unknown-linux-gnu --passes=slp-vectorizer -mattr=+v -S
; Original: RUN: opt -S -mtriple riscv64-unknown-linux-gnu < %s --passes=slp-vectorizer -mattr=+v | FileCheck %s
...
; ModuleID = '/tmp/tmp45sfkwle.ll'
source_filename = "/tmp/tmp45sfkwle.ll"
...
entry:
  ...
  %2 = load <4 x i8>, ptr %pix1, align 1
  %3 = zext <4 x i8> %2 to <4 x i32>
  %4 = load <4 x i8>, ptr %pix2, align 1
  %5 = zext <4 x i8> %4 to <4 x i32>
  %6 = sub <4 x i32> %3, %5
  %7 = load <4 x i8>, ptr %arrayidx3, align 1
  %8 = zext <4 x i8> %7 to <4 x i32>
  %9 = load <4 x i8>, ptr %arrayidx5, align 1
  %10 = zext <4 x i8> %9 to <4 x i32>
  %11 = sub <4 x i32> %8, %10
  %12 = shl <4 x i32> %11, splat (i32 16)
  %13 = add <4 x i32> %12, %6
  %14 = shufflevector <4 x i32> %13, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %15 = add <4 x i32> %14, %13
  %16 = sub <4 x i32> %14, %13
  %17 = shufflevector <4 x i32> %15, <4 x i32> %16, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %18 = shufflevector <4 x i32> %17, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %19 = add <4 x i32> %17, %18
  %20 = sub <4 x i32> %17, %18
  %21 = shufflevector <4 x i32> %19, <4 x i32> %20, <4 x i32> <i32 4, i32 5, i32 2, i32 3>
  %22 = load <4 x i8>, ptr %add.ptr3, align 1
  %23 = zext <4 x i8> %22 to <4 x i32>
  %24 = load <4 x i8>, ptr %add.ptr644, align 1
  %25 = zext <4 x i8> %24 to <4 x i32>
  %26 = sub <4 x i32> %23, %25
  %27 = load <4 x i8>, ptr %arrayidx3.1, align 1
  %28 = zext <4 x i8> %27 to <4 x i32>
  %29 = load <4 x i8>, ptr %arrayidx5.1, align 1
  %30 = zext <4 x i8> %29 to <4 x i32>
  %31 = sub <4 x i32> %28, %30
  %32 = shl <4 x i32> %31, splat (i32 16)
  %33 = add <4 x i32> %32, %26
  %34 = shufflevector <4 x i32> %33, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %35 = add <4 x i32> %34, %33
  %36 = sub <4 x i32> %34, %33
  %37 = shufflevector <4 x i32> %35, <4 x i32> %36, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %38 = shufflevector <4 x i32> %37, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %39 = add <4 x i32> %37, %38
  %40 = sub <4 x i32> %37, %38
  %41 = shufflevector <4 x i32> %39, <4 x i32> %40, <4 x i32> <i32 4, i32 5, i32 2, i32 3>
  %42 = load <4 x i8>, ptr %add.ptr.1, align 1
  %43 = zext <4 x i8> %42 to <4 x i32>
  %44 = load <4 x i8>, ptr %add.ptr64.1, align 1
  %45 = zext <4 x i8> %44 to <4 x i32>
  %46 = sub <4 x i32> %43, %45
  %47 = load <4 x i8>, ptr %arrayidx3.2, align 1
  %48 = zext <4 x i8> %47 to <4 x i32>
  %49 = load <4 x i8>, ptr %arrayidx5.2, align 1
  %50 = zext <4 x i8> %49 to <4 x i32>
  %51 = sub <4 x i32> %48, %50
  %52 = shl <4 x i32> %51, splat (i32 16)
  %53 = add <4 x i32> %52, %46
  %54 = shufflevector <4 x i32> %53, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %55 = add <4 x i32> %54, %53
  %56 = sub <4 x i32> %54, %53
  %57 = shufflevector <4 x i32> %55, <4 x i32> %56, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %58 = shufflevector <4 x i32> %57, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %59 = add <4 x i32> %57, %58
  %60 = sub <4 x i32> %57, %58
  %61 = shufflevector <4 x i32> %59, <4 x i32> %60, <4 x i32> <i32 2, i32 3, i32 4, i32 5>
  %62 = load <4 x i8>, ptr null, align 1
  %63 = zext <4 x i8> %62 to <4 x i32>
  %64 = load <4 x i8>, ptr null, align 1
  %65 = zext <4 x i8> %64 to <4 x i32>
  %66 = sub <4 x i32> %63, %65
  %67 = shufflevector <4 x i32> %66, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %68 = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 4, <2 x i1> splat (i1 true), i32 2)
  %69 = insertelement <2 x i8> poison, i8 %1, i32 0
  %70 = insertelement <2 x i8> %69, i8 %0, i32 1
  %71 = load <4 x i8>, ptr %arrayidx5.3, align 1
  %72 = zext <4 x i8> %71 to <4 x i32>
  %73 = shufflevector <4 x i32> %72, <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %74 = zext <2 x i8> %70 to <2 x i32>
  %75 = shufflevector <2 x i32> %74, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %76 = zext <2 x i8> %68 to <2 x i32>
  %77 = shufflevector <2 x i32> %76, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %78 = shufflevector <4 x i32> %75, <4 x i32> %77, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %79 = sub <4 x i32> %78, %73
  %80 = shl <4 x i32> %79, splat (i32 16)
  %81 = add <4 x i32> %80, %67
  %82 = shufflevector <4 x i32> %81, <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
  %83 = add <4 x i32> %81, %82
  %84 = sub <4 x i32> %81, %82
  %85 = shufflevector <4 x i32> %83, <4 x i32> %84, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %86 = shufflevector <4 x i32> %85, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %87 = add <4 x i32> %85, %86
  %88 = sub <4 x i32> %85, %86
  %89 = shufflevector <4 x i32> %87, <4 x i32> %88, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %90 = shufflevector <4 x i32> %41, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %91 = shufflevector <4 x i32> %21, <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %92 = add <4 x i32> %90, %91
  %93 = sub <4 x i32> %21, %41
  %94 = shufflevector <4 x i32> %93, <4 x i32> %92, <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 4, i32 5, i32 6, i32 7>
  %95 = add <4 x i32> %89, %61
  %96 = sub <4 x i32> %61, %89
  %97 = shufflevector <4 x i32> %96, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %98 = shufflevector <4 x i32> %95, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %99 = shufflevector <8 x i32> %97, <8 x i32> %98, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %100 = add <8 x i32> %99, %94
  %101 = sub <8 x i32> %94, %99
  %102 = shufflevector <8 x i32> %100, <8 x i32> %101, <16 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7, i32 12, i32 8, i32 13, i32 9, i32 14, i32 10, i32 15, i32 11>
  %103 = shufflevector <4 x i32> %57, <4 x i32> %63, <16 x i32> <i32 2, i32 4, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %104 = shufflevector <4 x i32> %43, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %105 = shufflevector <16 x i32> %103, <16 x i32> %104, <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %106 = shufflevector <4 x i32> %23, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %107 = shufflevector <16 x i32> %105, <16 x i32> %106, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 18, i32 poison, i32 poison, i32 poison>
  %108 = shufflevector <4 x i32> %3, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %109 = shufflevector <16 x i32> %107, <16 x i32> %108, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 12, i32 poison, i32 18, i32 19>
  %110 = shufflevector <4 x i32> %37, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %111 = shufflevector <16 x i32> %109, <16 x i32> %110, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 18, i32 poison, i32 19, i32 poison, i32 12, i32 poison, i32 14, i32 15>
  %112 = shufflevector <4 x i32> %17, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %113 = shufflevector <16 x i32> %111, <16 x i32> %112, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 18, i32 10, i32 19, i32 12, i32 16, i32 14, i32 15>
  %114 = lshr <16 x i32> %113, splat (i32 15)
  %115 = and <16 x i32> %114, splat (i32 65537)
  %116 = mul <16 x i32> %115, splat (i32 65535)
  %117 = add <16 x i32> %116, %102
  %118 = xor <16 x i32> %117, %113
  %119 = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %118)
  ret i32 %119
}
...
declare <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr captures(none), i64, <2 x i1>, i32) #2
