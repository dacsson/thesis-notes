; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/basic-strided-loads.ll
; Variant: riscv64_+m,+v,+unaligned-vector-mem_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+m,+v,+unaligned-vector-mem -passes=slp-vectorizer -S
; Original: RUN: opt -mtriple=riscv64 -mattr=+m,+v,+unaligned-vector-mem -passes=slp-vectorizer -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpr5vp5uxf.ll'
source_filename = "/tmp/tmpr5vp5uxf.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64"

define void @const_stride_1_no_reordering(ptr %pl, ptr %ps) #0 {
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = load <16 x i8>, ptr %gep_l0, align 1
  store <16 x i8> %1, ptr %gep_s0, align 1
  ret void
}

define void @const_stride_1_with_reordering(ptr %pl, ptr %ps) #0 {
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = load <16 x i8>, ptr %gep_l0, align 1
  %2 = shufflevector <16 x i8> %1, <16 x i8> poison, <16 x i32> <i32 1, i32 0, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  store <16 x i8> %2, ptr %gep_s0, align 1
  ret void
}

define void @const_stride_2_no_reordering(ptr %pl, ptr %ps) #0 {
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = call <31 x i8> @llvm.masked.load.v31i8.p0(ptr align 1 %gep_l0, <31 x i1> <i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true>, <31 x i8> poison)
  %2 = shufflevector <31 x i8> %1, <31 x i8> poison, <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
  store <16 x i8> %2, ptr %gep_s0, align 1
  ret void
}

define void @const_stride_2_with_reordering(ptr %pl, ptr %ps) #0 {
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = call <31 x i8> @llvm.masked.load.v31i8.p0(ptr align 1 %gep_l0, <31 x i1> <i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true>, <31 x i8> poison)
  %2 = shufflevector <31 x i8> %1, <31 x i8> poison, <16 x i32> <i32 2, i32 0, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
  store <16 x i8> %2, ptr %gep_s0, align 1
  ret void
}

define void @rt_stride_1_no_reordering(ptr %pl, i64 %stride, ptr %ps) #0 {
  %stride0 = mul nsw i64 %stride, 0
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 %stride0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = mul i64 %stride, 1
  %2 = call <16 x i8> @llvm.experimental.vp.strided.load.v16i8.p0.i64(ptr align 1 %gep_l0, i64 %1, <16 x i1> splat (i1 true), i32 16)
  store <16 x i8> %2, ptr %gep_s0, align 1
  ret void
}

define void @rt_stride_1_no_reordering_i16(ptr %pl, i64 %stride, ptr %ps) #0 {
  %stride0 = mul nsw i64 %stride, 0
  %gep_l0 = getelementptr inbounds i16, ptr %pl, i64 %stride0
  %gep_s0 = getelementptr inbounds i16, ptr %ps, i64 0
  %1 = mul i64 %stride, 2
  %2 = call <16 x i16> @llvm.experimental.vp.strided.load.v16i16.p0.i64(ptr align 1 %gep_l0, i64 %1, <16 x i1> splat (i1 true), i32 16)
  store <16 x i16> %2, ptr %gep_s0, align 1
  ret void
}

define void @rt_stride_1_with_reordering(ptr %pl, i64 %stride, ptr %ps) #0 {
  %stride0 = mul nsw i64 %stride, 0
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 %stride0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = mul i64 %stride, 1
  %2 = call <16 x i8> @llvm.experimental.vp.strided.load.v16i8.p0.i64(ptr align 1 %gep_l0, i64 %1, <16 x i1> splat (i1 true), i32 16)
  %3 = shufflevector <16 x i8> %2, <16 x i8> poison, <16 x i32> <i32 1, i32 0, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  store <16 x i8> %3, ptr %gep_s0, align 1
  ret void
}

define void @constant_stride_masked_no_reordering(ptr %pl, i64 %stride, ptr %ps) #0 {
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = call <28 x i8> @llvm.masked.load.v28i8.p0(ptr align 1 %gep_l0, <28 x i1> <i1 true, i1 true, i1 true, i1 true, i1 false, i1 false, i1 false, i1 false, i1 true, i1 true, i1 true, i1 true, i1 false, i1 false, i1 false, i1 false, i1 true, i1 true, i1 true, i1 true, i1 false, i1 false, i1 false, i1 false, i1 true, i1 true, i1 true, i1 true>, <28 x i8> poison)
  %2 = shufflevector <28 x i8> %1, <28 x i8> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19, i32 24, i32 25, i32 26, i32 27>
  store <16 x i8> %2, ptr %gep_s0, align 1
  ret void
}
...
define void @rt_stride_widen_no_reordering(ptr %pl, i64 %stride, ptr %ps) #0 {
  %offset0 = mul nsw i64 %stride, 0
  %gep_l0 = getelementptr inbounds i8, ptr %pl, i64 %offset0
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = mul i64 %stride, 1
  %2 = call <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr align 1 %gep_l0, i64 %1, <4 x i1> splat (i1 true), i32 4)
  %3 = bitcast <4 x i32> %2 to <16 x i8>
  store <16 x i8> %3, ptr %gep_s0, align 1
  ret void
}

define void @rt_stride_mul_scev(ptr %pl, i64 %base_stride, ptr %ps) #0 {
  %stride = mul i64 %base_stride, 2
  %gep_s0 = getelementptr inbounds i8, ptr %ps, i64 0
  %1 = insertelement <8 x i64> poison, i64 %stride, i32 0
  %2 = shufflevector <8 x i64> %1, <8 x i64> poison, <8 x i32> zeroinitializer
  %3 = mul nsw <8 x i64> %2, <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7>
  %4 = insertelement <8 x ptr> poison, ptr %pl, i32 0
  %5 = shufflevector <8 x ptr> %4, <8 x ptr> poison, <8 x i32> zeroinitializer
  %6 = getelementptr i8, <8 x ptr> %5, <8 x i64> %3
  %7 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> align 1 %6, <8 x i1> splat (i1 true), <8 x i8> poison)
  store <8 x i8> %7, ptr %gep_s0, align 1
  ret void
}

define void @rt_stride_widen_no_reordering_i16(ptr %pl, i64 %stride, ptr %ps) #0 {
  %offset0 = mul nsw i64 %stride, 0
  %gep_l0 = getelementptr inbounds i16, ptr %pl, i64 %offset0
  %gep_s0 = getelementptr inbounds i16, ptr %ps, i64 0
  %1 = mul i64 %stride, 2
  %2 = call <4 x i64> @llvm.experimental.vp.strided.load.v4i64.p0.i64(ptr align 1 %gep_l0, i64 %1, <4 x i1> splat (i1 true), i32 4)
  %3 = bitcast <4 x i64> %2 to <16 x i16>
  store <16 x i16> %3, ptr %gep_s0, align 1
  ret void
}

define void @two_wide(ptr %pl, ptr %ps, i64 %stride) #0 {
  %gep_l0 = getelementptr i8, ptr %pl, i64 0
  %gep_s0 = getelementptr i8, ptr %ps, i64 0
  %1 = mul i64 %stride, 1
  %2 = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 %gep_l0, i64 %1, <2 x i1> splat (i1 true), i32 2)
  store <2 x i8> %2, ptr %gep_s0, align 1
  ret void
}

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <31 x i8> @llvm.masked.load.v31i8.p0(ptr captures(none), <31 x i1>, <31 x i8>) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <16 x i8> @llvm.experimental.vp.strided.load.v16i8.p0.i64(ptr captures(none), i64, <16 x i1>, i32) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <16 x i16> @llvm.experimental.vp.strided.load.v16i16.p0.i64(ptr captures(none), i64, <16 x i1>, i32) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <28 x i8> @llvm.masked.load.v28i8.p0(ptr captures(none), <28 x i1>, <28 x i8>) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <4 x i32> @llvm.experimental.vp.strided.load.v4i32.p0.i64(ptr captures(none), i64, <4 x i1>, i32) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr>, <8 x i1>, <8 x i8>) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <4 x i64> @llvm.experimental.vp.strided.load.v4i64.p0.i64(ptr captures(none), i64, <4 x i1>, i32) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr captures(none), i64, <2 x i1>, i32) #1

attributes #0 = { "target-features"="+m,+v,+unaligned-vector-mem" }
