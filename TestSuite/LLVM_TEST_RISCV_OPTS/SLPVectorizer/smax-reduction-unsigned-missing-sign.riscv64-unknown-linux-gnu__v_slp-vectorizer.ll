; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SLPVectorizer/RISCV/smax-reduction-unsigned-missing-sign.ll
...
; ModuleID = '/tmp/tmp5649m8k8.ll'
source_filename = "/tmp/tmp5649m8k8.ll"
...
entry:
  ...
  %4 = call i8 @llvm.vector.reduce.smax.v4i8(<4 x i8> %3)
  %5 = zext i8 %4 to i32
  ret i32 %5
}
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.smax.v4i8(<4 x i8>) #2
