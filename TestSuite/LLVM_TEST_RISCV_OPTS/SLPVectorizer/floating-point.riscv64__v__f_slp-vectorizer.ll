...
; Variant: riscv64_+v,+f_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+v,+f -riscv-v-vector-bits-min=-1 -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt < %s -passes=slp-vectorizer -S -mtriple=riscv64 -mattr=+v,+f  -riscv-v-vector-bits-min=-1 -riscv-v-slp-max-vf=0  | FileCheck %s
...
; ModuleID = '/tmp/tmpvgdm0tw3.ll'
source_filename = "/tmp/tmpvgdm0tw3.ll"
