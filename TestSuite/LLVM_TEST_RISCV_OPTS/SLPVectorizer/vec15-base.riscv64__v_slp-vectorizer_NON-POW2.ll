...
; Variant: riscv64_+v_slp-vectorizer_NON-POW2
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -slp-vectorize-non-power-of-2 -mtriple=riscv64 -mattr=+v -S
; Original: RUN: opt -passes=slp-vectorizer -slp-vectorize-non-power-of-2 -mtriple=riscv64 -mattr=+v -S %s | FileCheck --check-prefixes=NON-POW2 %s
...
; ModuleID = '/tmp/tmp57fle2ey.ll'
source_filename = "/tmp/tmp57fle2ey.ll"
...
entry:
  %gep.src.0 = getelementptr inbounds i8, ptr %src, i8 0
  %0 = load <15 x i8>, ptr %gep.src.0, align 4
  %1 = mul nsw <15 x i8> %0, splat (i8 10)
  store <15 x i8> %1, ptr %dst, align 1
  ret void
}
