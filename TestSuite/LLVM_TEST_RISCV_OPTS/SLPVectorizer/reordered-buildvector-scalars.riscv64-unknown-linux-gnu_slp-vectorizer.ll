...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt --passes=slp-vectorizer -mtriple=riscv64-unknown-linux-gnu -mcpu=sifive-x280 -S
; Original: RUN: opt -S --passes=slp-vectorizer -mtriple=riscv64-unknown-linux-gnu -mcpu=sifive-x280 < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpboa3ol2q.ll'
source_filename = "/tmp/tmpboa3ol2q.ll"
...
entry:
  ...
  %9 = insertelement <8 x i32> %8, i32 %0, i32 4
  %10 = insertelement <8 x i32> %9, i32 %add111.i.i, i32 6
  %11 = insertelement <8 x i32> %10, i32 %add2235.i16, i32 1
  %12 = insertelement <8 x i32> %11, i32 %LoopArray.sroa.24.0.i.i3, i32 2
  ...
  %20 = insertelement <4 x i32> poison, i32 %0, i32 2
  %21 = insertelement <4 x i32> %20, i32 %LoopArray.sroa.24.0.i.i3, i32 0
  %22 = insertelement <4 x i32> %21, i32 %add1392.i, i32 1
  %23 = insertelement <4 x i32> %22, i32 %shr143.5.i.i9, i32 3
  %24 = or <4 x i32> %23, splat (i32 1)
  %25 = shufflevector <3 x i32> %6, <3 x i32> poison, <4 x i32> zeroinitializer
  %26 = add <4 x i32> %24, %25
  %27 = shufflevector <11 x i32> %19, <11 x i32> poison, <15 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 poison, i32 poison, i32 poison, i32 poison>
  %28 = shufflevector <4 x i32> %26, <4 x i32> poison, <15 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %29 = shufflevector <15 x i32> %27, <15 x i32> %28, <15 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 15, i32 16, i32 17, i32 18>
  %30 = trunc <15 x i32> %29 to <15 x i16>
  %31 = shufflevector <15 x i16> %30, <15 x i16> poison, <32 x i32> <i32 0, i32 8, i32 9, i32 1, i32 11, i32 2, i32 3, i32 4, i32 5, i32 6, i32 0, i32 8, i32 9, i32 1, i32 11, i32 10, i32 12, i32 4, i32 5, i32 6, i32 0, i32 8, i32 9, i32 7, i32 13, i32 10, i32 12, i32 4, i32 5, i32 6, i32 0, i32 14>
  store <32 x i16> %31, ptr getelementptr inbounds nuw (i8, ptr @images, i64 8170), align 2
  ret i32 0
}
