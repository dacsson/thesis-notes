...
; Variant: riscv64_+m,+v_slp-vectorizer_1
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -slp-vectorize-non-power-of-2=false -mtriple=riscv64 -mattr=+m,+v -S
; Original: RUN: opt -passes=slp-vectorizer -slp-vectorize-non-power-of-2=false -mtriple=riscv64 -mattr=+m,+v -S %s | FileCheck --check-prefixes=CHECK,POW2-ONLY %s
...
; ModuleID = '/tmp/tmp7okaknt2.ll'
source_filename = "/tmp/tmp7okaknt2.ll"
...
entry:
  ...
  %l.src.2 = load i32, ptr %gep.src.2, align 4
  %mul.2 = mul nsw i32 %l.src.2, 10
  %0 = load <2 x i32>, ptr %gep.src.0, align 4
  %1 = mul nsw <2 x i32> %0, splat (i32 10)
  store <2 x i32> %1, ptr %dst, align 4
  %dst.2 = getelementptr i32, ptr %dst, i32 2
  store i32 %mul.2, ptr %dst.2, align 4
  ret void
}
...
entry:
  ...
  %l.src.2.2 = load i32, ptr %gep.src.2.2, align 4
  %mul.2 = mul nsw i32 %l.src.1.2, %l.src.2.2
  %0 = load <2 x i32>, ptr %gep.src.1.0, align 4
  %1 = load <2 x i32>, ptr %gep.src.2.0, align 4
  %2 = mul nsw <2 x i32> %0, %1
  store <2 x i32> %2, ptr %dst, align 4
  %dst.2 = getelementptr i32, ptr %dst, i32 2
  store i32 %mul.2, ptr %dst.2, align 4
  ret void
}
...
entry:
  ...
  %1 = load <2 x i32>, ptr %gep.src.2.0, align 4
  %2 = mul nsw <2 x i32> %0, %1
  %3 = add <2 x i32> %2, splat (i32 9)
  store <2 x i32> %3, ptr %dst, align 4
  %dst.2 = getelementptr i32, ptr %dst, i32 2
  store i32 %add.2, ptr %dst.2, align 4
  ret void
}
...
entry:
  ...
  %gep.src.2 = getelementptr inbounds float, ptr %src, i32 2
  %l.src.2 = load float, ptr %gep.src.2, align 4
  %fadd.2 = fadd float %l.src.2, 1.000000e+01
  %0 = load <2 x float>, ptr %gep.src.0, align 4
  %1 = fadd <2 x float> %0, splat (float 1.000000e+01)
  store <2 x float> %1, ptr %dst, align 4
  %dst.2 = getelementptr float, ptr %dst, i32 2
  store float %fadd.2, ptr %dst.2, align 4
  ret void
}
...
exit:                                             ; preds = %invoke.cont8.loopexit, %entry
  %p.2 = phi i32 [ 3, %entry ], [ 0, %invoke.cont8.loopexit ]
  %0 = phi <2 x i32> [ <i32 1, i32 2>, %entry ], [ poison, %invoke.cont8.loopexit ]
  %dst.2 = getelementptr i32, ptr %dst, i32 2
...
entry:
  store <2 x i32> zeroinitializer, ptr %dst, align 4
  %add216 = sub i32 0, 0
  %arrayidx.i1891 = getelementptr i32, ptr %dst, i64 2
  store i32 %add216, ptr %arrayidx.i1891, align 4
  ret void
...
entry:
  %arrayidx80 = getelementptr float, ptr %Colour, i64 2
  %1 = insertelement <2 x float> poison, float %0, i32 0
  %2 = shufflevector <2 x float> %1, <2 x float> poison, <2 x i32> zeroinitializer
  %3 = fpext <2 x float> %2 to <2 x double>
  %4 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> zeroinitializer, <2 x double> zeroinitializer)
  %5 = fptrunc <2 x double> %4 to <2 x float>
  store <2 x float> %5, ptr %Colour, align 4
  %conv78 = fpext float %0 to double
  %6 = call double @llvm.fmuladd.f64(double %conv78, double 0.000000e+00, double 0.000000e+00)
  %conv82 = fptrunc double %6 to float
  store float %conv82, ptr %arrayidx80, align 4
  ret void
}
...
define i32 @dot_product_i32(ptr %a, ptr %b) #0 {
  ...
  %gep.b.2 = getelementptr inbounds i32, ptr %b, i32 2
  %l.b.2 = load i32, ptr %gep.b.2, align 4
  %1 = load <2 x i32>, ptr %gep.a.0, align 4
  %2 = load <2 x i32>, ptr %gep.b.0, align 4
  %3 = mul nsw <2 x i32> %1, %2
  %mul.2 = mul nsw i32 %l.a.2, %l.b.2
  %4 = call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %3)
  %add.1 = add i32 %4, %mul.2
  ret i32 %add.1
}
