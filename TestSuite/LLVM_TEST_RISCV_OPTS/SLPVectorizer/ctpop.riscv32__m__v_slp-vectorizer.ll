...
; Variant: riscv32_+m,+v_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv32 -mattr=+m,+v -S
; Original: RUN: opt < %s -passes=slp-vectorizer -S -mtriple=riscv32 -mattr=+m,+v | FileCheck %s
...
; ModuleID = '/tmp/tmp6ru9k4w_.ll'
source_filename = "/tmp/tmp6ru9k4w_.ll"
