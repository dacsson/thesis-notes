...
; Variant: riscv64_+v,+zvfhmin,+zvfbfmin_slp-vectorizer
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=slp-vectorizer -mtriple=riscv64 -mattr=+v,+zvfhmin,+zvfbfmin -riscv-v-slp-max-vf=0 -S
; Original: RUN: opt < %s -passes=slp-vectorizer -mtriple=riscv64  -mattr=+v,+zvfhmin,+zvfbfmin -riscv-v-slp-max-vf=0 -S  | FileCheck %s --check-prefixes=CHECK,ZVFHMIN
...
; ModuleID = '/tmp/tmps82ud08c.ll'
source_filename = "/tmp/tmps82ud08c.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64"
...
attributes #1 = { nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvfhmin,+zvfbfmin" }
attributes #2 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+v,+zvfhmin,+zvfbfmin" }
