...
; Variant: riscv64_+v_loop-vectorize_1
...
; Original: RUN: opt -passes=loop-vectorize  -tail-folding-policy=dont-fold-tail  -mtriple=riscv64 -mattr=+v -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpzwz4ipud.ll'
source_filename = "/tmp/tmpzwz4ipud.ll"
