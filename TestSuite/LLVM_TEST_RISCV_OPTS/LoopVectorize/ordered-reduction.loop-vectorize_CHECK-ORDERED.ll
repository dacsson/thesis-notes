...
; Variant: loop-vectorize_CHECK-ORDERED
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -hints-allow-reordering=false -S
; Original: RUN: opt -passes=loop-vectorize -hints-allow-reordering=false -S < %s | FileCheck %s --check-prefix=CHECK-ORDERED
...
; ModuleID = '/tmp/tmpj10jc9bu.ll'
source_filename = "/tmp/tmpj10jc9bu.ll"
