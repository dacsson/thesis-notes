...
; Variant: riscv64_+v_loop-vectorize_NO-ZVFHMIN_2
...
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S -tail-folding-policy=prefer-fold-tail | FileCheck %s -check-prefix=NO-ZVFHMIN
...
; ModuleID = '/tmp/tmpg55ul9y7.ll'
source_filename = "/tmp/tmpg55ul9y7.ll"
