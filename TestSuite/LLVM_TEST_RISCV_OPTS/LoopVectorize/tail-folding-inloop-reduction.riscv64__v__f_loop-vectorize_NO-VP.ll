...
; ModuleID = '/tmp/tmp_t8jeewm.ll'
source_filename = "/tmp/tmp_t8jeewm.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = call i32 @llvm.vector.reduce.add.nxv4i32(<vscale x 4 x i32> %wide.load)
  %5 = add i32 %vec.phi, %4
...
scalar.ph:                                        ; preds = %entry, %middle.block
  ...
  %bc.merge.rdx = phi i32 [ %5, %middle.block ], [ %start, %entry ]
  br label %for.body
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %add = add nsw i32 %7, %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !3

for.end:                                          ; preds = %middle.block, %for.body
  %add.lcssa = phi i32 [ %add, %for.body ], [ %5, %middle.block ]
  ret i32 %add.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.or.nxv4i32(<vscale x 4 x i32> %wide.load)
  %5 = or i32 %vec.phi, %4
  %index.next = add nuw i64 %index, %2
  %6 = icmp eq i64 %index.next, %n.vec
...
for.end:                                          ; preds = %middle.block, %for.body
  %or.lcssa = phi i32 [ %or, %for.body ], [ %5, %middle.block ]
  ret i32 %or.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.and.nxv4i32(<vscale x 4 x i32> %wide.load)
  %5 = and i32 %vec.phi, %4
  %index.next = add nuw i64 %index, %2
  %6 = icmp eq i64 %index.next, %n.vec
...
for.end:                                          ; preds = %middle.block, %for.body
  %and.lcssa = phi i32 [ %and, %for.body ], [ %5, %middle.block ]
  ret i32 %and.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.xor.nxv4i32(<vscale x 4 x i32> %wide.load)
  %5 = xor i32 %vec.phi, %4
  %index.next = add nuw i64 %index, %2
  %6 = icmp eq i64 %index.next, %n.vec
...
for.end:                                          ; preds = %middle.block, %for.body
  %xor.lcssa = phi i32 [ %xor, %for.body ], [ %5, %middle.block ]
  ret i32 %xor.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.smin.nxv4i32(<vscale x 4 x i32> %wide.load)
  %rdx.minmax = call i32 @llvm.smin.i32(i32 %4, i32 %vec.phi)
  %index.next = add nuw i64 %index, %2
...
scalar.ph:                                        ; preds = %entry, %middle.block
  %bc.resume.val = phi i64 [ %n.vec, %middle.block ], [ 0, %entry ]
  %bc.merge.rdx = phi i32 [ %rdx.minmax, %middle.block ], [ %start, %entry ]
  br label %for.body
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %cmp.i = icmp slt i32 %6, %rdx
  %smin = select i1 %cmp.i, i32 %6, i32 %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !13

for.end:                                          ; preds = %middle.block, %for.body
  %smin.lcssa = phi i32 [ %smin, %for.body ], [ %rdx.minmax, %middle.block ]
  ret i32 %smin.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.smax.nxv4i32(<vscale x 4 x i32> %wide.load)
  %rdx.minmax = call i32 @llvm.smax.i32(i32 %4, i32 %vec.phi)
  %index.next = add nuw i64 %index, %2
  %5 = icmp eq i64 %index.next, %n.vec
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %arrayidx = getelementptr inbounds i32, ptr %a, i64 %iv
  %6 = load i32, ptr %arrayidx, align 4
  %cmp.i = icmp sgt i32 %6, %rdx
  %smax = select i1 %cmp.i, i32 %6, i32 %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !15

for.end:                                          ; preds = %middle.block, %for.body
  %smax.lcssa = phi i32 [ %smax, %for.body ], [ %rdx.minmax, %middle.block ]
  ret i32 %smax.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.umin.nxv4i32(<vscale x 4 x i32> %wide.load)
  %rdx.minmax = call i32 @llvm.umin.i32(i32 %4, i32 %vec.phi)
  %index.next = add nuw i64 %index, %2
  %5 = icmp eq i64 %index.next, %n.vec
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %arrayidx = getelementptr inbounds i32, ptr %a, i64 %iv
  %6 = load i32, ptr %arrayidx, align 4
  %cmp.i = icmp ult i32 %6, %rdx
  %umin = select i1 %cmp.i, i32 %6, i32 %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !17

for.end:                                          ; preds = %middle.block, %for.body
  %umin.lcssa = phi i32 [ %umin, %for.body ], [ %rdx.minmax, %middle.block ]
  ret i32 %umin.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x i32>, ptr %3, align 4
  %4 = call i32 @llvm.vector.reduce.umax.nxv4i32(<vscale x 4 x i32> %wide.load)
  %rdx.minmax = call i32 @llvm.umax.i32(i32 %4, i32 %vec.phi)
  %index.next = add nuw i64 %index, %2
  %5 = icmp eq i64 %index.next, %n.vec
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %arrayidx = getelementptr inbounds i32, ptr %a, i64 %iv
  %6 = load i32, ptr %arrayidx, align 4
  %cmp.i = icmp ugt i32 %6, %rdx
  %umax = select i1 %cmp.i, i32 %6, i32 %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !19

for.end:                                          ; preds = %middle.block, %for.body
  %umax.lcssa = phi i32 [ %umax, %for.body ], [ %rdx.minmax, %middle.block ]
  ret i32 %umax.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = call reassoc float @llvm.vector.reduce.fadd.nxv4f32(float -0.000000e+00, <vscale x 4 x float> %wide.load)
  %5 = fadd reassoc float %vec.phi, %4
  %index.next = add nuw i64 %index, %2
  %6 = icmp eq i64 %index.next, %n.vec
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %add = fadd reassoc float %7, %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !21

for.end:                                          ; preds = %middle.block, %for.body
  %add.lcssa = phi float [ %add, %for.body ], [ %5, %middle.block ]
  ret float %add.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds float, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x float>, ptr %3, align 4
  %4 = call fast float @llvm.vector.reduce.fmin.nxv4f32(<vscale x 4 x float> %wide.load)
  %rdx.minmax.cmp = fcmp fast olt float %4, %vec.phi
  %rdx.minmax.select = select fast i1 %rdx.minmax.cmp, float %4, float %vec.phi
  %index.next = add nuw i64 %index, %2
  %5 = icmp eq i64 %index.next, %n.vec
  br i1 %5, label %middle.block, label %vector.body, !llvm.loop !24
...
scalar.ph:                                        ; preds = %entry, %middle.block
  %bc.resume.val = phi i64 [ %n.vec, %middle.block ], [ 0, %entry ]
  %bc.merge.rdx = phi float [ %rdx.minmax.select, %middle.block ], [ %start, %entry ]
  br label %for.body
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %cmp = fcmp fast olt float %6, %rdx
  %min = select nnan nsz i1 %cmp, float %6, float %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !25

for.end:                                          ; preds = %middle.block, %for.body
  %min.lcssa = phi float [ %min, %for.body ], [ %rdx.minmax.select, %middle.block ]
  ret float %min.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds float, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x float>, ptr %3, align 4
  %4 = call fast float @llvm.vector.reduce.fmax.nxv4f32(<vscale x 4 x float> %wide.load)
  %rdx.minmax.cmp = fcmp fast ogt float %4, %vec.phi
  %rdx.minmax.select = select fast i1 %rdx.minmax.cmp, float %4, float %vec.phi
  %index.next = add nuw i64 %index, %2
  %5 = icmp eq i64 %index.next, %n.vec
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %arrayidx = getelementptr inbounds float, ptr %a, i64 %iv
  %6 = load float, ptr %arrayidx, align 4
  %cmp = fcmp fast ogt float %6, %rdx
  %max = select nnan nsz i1 %cmp, float %6, float %rdx
  %iv.next = add nuw nsw i64 %iv, 1
  %exitcond.not = icmp eq i64 %iv.next, %n
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !27

for.end:                                          ; preds = %middle.block, %for.body
  %max.lcssa = phi float [ %max, %for.body ], [ %rdx.minmax.select, %middle.block ]
  ret float %max.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi float [ %start, %vector.ph ], [ %7, %vector.body ]
  %3 = getelementptr inbounds float, ptr %a, i64 %index
  %wide.load = load <vscale x 4 x float>, ptr %3, align 4
  %4 = getelementptr inbounds float, ptr %b, i64 %index
  %wide.load1 = load <vscale x 4 x float>, ptr %4, align 4
  %5 = fmul reassoc <vscale x 4 x float> %wide.load, %wide.load1
  %6 = call reassoc float @llvm.vector.reduce.fadd.nxv4f32(float -0.000000e+00, <vscale x 4 x float> %5)
  %7 = fadd reassoc float %vec.phi, %6
  %index.next = add nuw i64 %index, %2
...
for.end:                                          ; preds = %middle.block, %for.body
  %muladd.lcssa = phi float [ %muladd, %for.body ], [ %7, %middle.block ]
...
; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.vector.reduce.fmul.v4f32(float, <4 x float>) #3
