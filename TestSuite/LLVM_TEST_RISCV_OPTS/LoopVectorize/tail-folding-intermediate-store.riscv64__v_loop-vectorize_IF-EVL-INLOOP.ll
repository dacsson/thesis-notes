...
; ModuleID = '/tmp/tmp27eawdmj.ll'
source_filename = "/tmp/tmp27eawdmj.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %2, <vscale x 4 x i1> splat (i1 true), i32 %1), !alias.scope !0
  %3 = call i32 @llvm.vp.reduce.add.nxv4i32(i32 0, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %1)
  %4 = add i32 %3, %vec.phi
  %5 = zext i32 %1 to i64
...
middle.block:                                     ; preds = %vector.body
  store i32 %4, ptr %addr, align 4, !alias.scope !6, !noalias !0
  br label %for.end
