...
; Variant: riscv64_+v_loop-vectorize_NO-ZVFBFMIN_1
...
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S -tail-folding-policy=dont-fold-tail | FileCheck %s -check-prefix=NO-ZVFBFMIN
...
; ModuleID = '/tmp/tmp7lpj6dhx.ll'
source_filename = "/tmp/tmp7lpj6dhx.ll"
