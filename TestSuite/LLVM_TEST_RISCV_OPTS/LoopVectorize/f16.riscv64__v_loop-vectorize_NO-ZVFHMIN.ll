...
; Variant: riscv64_+v_loop-vectorize_NO-ZVFHMIN
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S | FileCheck %s -check-prefix=NO-ZVFHMIN
...
; ModuleID = '/tmp/tmpo9u5em75.ll'
source_filename = "/tmp/tmpo9u5em75.ll"
