...
; Variant: riscv64_+rva23u64,+zvl1024b_loop-vectorize
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple riscv64 -mattr=+rva23u64,+zvl1024b -S
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+rva23u64,+zvl1024b -S | FileCheck %s -check-prefixes=CHECK,RVA23ZVL1024B
...
; ModuleID = '/tmp/tmpofltqw3k.ll'
source_filename = "/tmp/tmpofltqw3k.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = mul <vscale x 2 x i64> %vec.ind, splat (i64 7)
  %4 = getelementptr i8, ptr %start, <vscale x 2 x i64> %3
  call void @llvm.vp.scatter.nxv2i8.nxv2p0(<vscale x 2 x i8> zeroinitializer, <vscale x 2 x ptr> align 1 %4, <vscale x 2 x i1> splat (i1 true), i32 %1)
  %avl.next = sub nuw i64 %avl, %2
  %vec.ind.next = add <vscale x 2 x i64> %vec.ind, %broadcast.splat
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %vec.phi = phi <vscale x 1 x i8> [ zeroinitializer, %vector.ph ], [ %14, %vector.body ]
  %avl = phi i32 [ 10, %vector.ph ], [ %avl.next, %vector.body ]
  %0 = call i32 @llvm.experimental.get.vector.length.i32(i32 %avl, i32 1, i1 true)
  %1 = load ptr, ptr %A, align 8
  %broadcast.splatinsert = insertelement <vscale x 1 x ptr> poison, ptr %1, i64 0
  ...
  %wide.masked.gather = call <vscale x 1 x i64> @llvm.vp.gather.nxv1i64.nxv1p0(<vscale x 1 x ptr> align 8 %broadcast.splat, <vscale x 1 x i1> splat (i1 true), i32 %0)
  %2 = icmp sgt <vscale x 1 x i64> %wide.masked.gather, zeroinitializer
  %3 = zext <vscale x 1 x i1> %2 to <vscale x 1 x i8>
  %4 = or <vscale x 1 x i8> %vec.phi, %3
  %5 = load ptr, ptr %B, align 8
  %broadcast.splatinsert1 = insertelement <vscale x 1 x ptr> poison, ptr %5, i64 0
  %broadcast.splat2 = shufflevector <vscale x 1 x ptr> %broadcast.splatinsert1, <vscale x 1 x ptr> poison, <vscale x 1 x i32> zeroinitializer
  %wide.masked.gather3 = call <vscale x 1 x i64> @llvm.vp.gather.nxv1i64.nxv1p0(<vscale x 1 x ptr> align 8 %broadcast.splat2, <vscale x 1 x i1> splat (i1 true), i32 %0)
  %6 = icmp sgt <vscale x 1 x i64> %wide.masked.gather3, zeroinitializer
  %7 = zext <vscale x 1 x i1> %6 to <vscale x 1 x i8>
  %8 = or <vscale x 1 x i8> %4, %7
  %9 = or <vscale x 1 x i8> %8, splat (i8 1)
  %10 = load ptr, ptr %C, align 8
  %broadcast.splatinsert4 = insertelement <vscale x 1 x ptr> poison, ptr %10, i64 0
  %broadcast.splat5 = shufflevector <vscale x 1 x ptr> %broadcast.splatinsert4, <vscale x 1 x ptr> poison, <vscale x 1 x i32> zeroinitializer
  %wide.masked.gather6 = call <vscale x 1 x i64> @llvm.vp.gather.nxv1i64.nxv1p0(<vscale x 1 x ptr> align 8 %broadcast.splat5, <vscale x 1 x i1> splat (i1 true), i32 %0)
  %11 = icmp sgt <vscale x 1 x i64> %wide.masked.gather6, zeroinitializer
  %12 = zext <vscale x 1 x i1> %11 to <vscale x 1 x i8>
  %13 = or <vscale x 1 x i8> %9, %12
  %14 = call <vscale x 1 x i8> @llvm.vp.merge.nxv1i8(<vscale x 1 x i1> splat (i1 true), <vscale x 1 x i8> %13, <vscale x 1 x i8> %vec.phi, i32 %0)
  %avl.next = sub nuw i32 %avl, %0
  %15 = icmp eq i32 %avl.next, 0
  br i1 %15, label %middle.block, label %vector.body, !llvm.loop !11

middle.block:                                     ; preds = %vector.body
  %16 = call i8 @llvm.vector.reduce.or.nxv1i8(<vscale x 1 x i8> %14)
  br label %exit
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare <vscale x 1 x i64> @llvm.vp.gather.nxv1i64.nxv1p0(<vscale x 1 x ptr>, <vscale x 1 x i1>, i32) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare <vscale x 1 x i8> @llvm.vp.merge.nxv1i8(<vscale x 1 x i1>, <vscale x 1 x i8>, <vscale x 1 x i8>, i32) #3

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i8 @llvm.vector.reduce.or.nxv1i8(<vscale x 1 x i8>) #2

attributes #0 = { "target-features"="+rva23u64,+zvl1024b" }
attributes #1 = { "target-features"="+zve64x,+zvl256b,+rva23u64,+zvl1024b" }
