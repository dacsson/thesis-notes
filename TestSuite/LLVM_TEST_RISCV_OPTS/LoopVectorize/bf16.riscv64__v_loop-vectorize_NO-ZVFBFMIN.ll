...
; Variant: riscv64_+v_loop-vectorize_NO-ZVFBFMIN
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S | FileCheck %s -check-prefix=NO-ZVFBFMIN
...
; ModuleID = '/tmp/tmpasiebypp.ll'
source_filename = "/tmp/tmpasiebypp.ll"
