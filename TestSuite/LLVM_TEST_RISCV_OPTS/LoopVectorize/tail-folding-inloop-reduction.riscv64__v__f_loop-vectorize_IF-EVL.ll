; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/LoopVectorize/RISCV/tail-folding-inloop-reduction.ll
...
; ModuleID = '/tmp/tmpjj1a1w3_.ll'
source_filename = "/tmp/tmpjj1a1w3_.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi i32 [ %start, %vector.ph ], [ %3, %vector.body ]
  ...
  %2 = call i32 @llvm.vp.reduce.add.nxv4i32(i32 0, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %3 = add i32 %2, %vec.phi
  %4 = zext i32 %0 to i64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi i32 [ %start, %vector.ph ], [ %3, %vector.body ]
  %vec.phi1 = phi i32 [ 1, %vector.ph ], [ %5, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load = load <4 x i32>, ptr %0, align 4
  %wide.load2 = load <4 x i32>, ptr %1, align 4
  %2 = call i32 @llvm.vector.reduce.mul.v4i32(<4 x i32> %wide.load)
  %3 = mul i32 %vec.phi, %2
  %4 = call i32 @llvm.vector.reduce.mul.v4i32(<4 x i32> %wide.load2)
  %5 = mul i32 %vec.phi1, %4
...
scalar.ph:                                        ; preds = %entry, %middle.block
  ...
  %bc.merge.rdx = phi i32 [ %bin.rdx, %middle.block ], [ %start, %entry ]
  br label %for.body
...
for.end:                                          ; preds = %middle.block, %for.body
  %mul.lcssa = phi i32 [ %mul, %for.body ], [ %bin.rdx, %middle.block ]
  ret i32 %mul.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.or.nxv4i32(i32 0, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %3 = or i32 %2, %vec.phi
  %4 = zext i32 %0 to i64
  %current.iteration.next = add i64 %4, %index
  %avl.next = sub nuw i64 %avl, %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.and.nxv4i32(i32 -1, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %3 = and i32 %2, %vec.phi
  %4 = zext i32 %0 to i64
  %current.iteration.next = add i64 %4, %index
  %avl.next = sub nuw i64 %avl, %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.xor.nxv4i32(i32 0, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %3 = xor i32 %2, %vec.phi
  %4 = zext i32 %0 to i64
  %current.iteration.next = add i64 %4, %index
  %avl.next = sub nuw i64 %avl, %4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %current.iteration.next, %vector.body ]
  %vec.phi = phi i32 [ %start, %vector.ph ], [ %rdx.minmax, %vector.body ]
  %avl = phi i64 [ %n, %vector.ph ], [ %avl.next, %vector.body ]
  %0 = call i32 @llvm.experimental.get.vector.length.i64(i64 %avl, i32 4, i1 true)
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.smin.nxv4i32(i32 2147483647, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax = call i32 @llvm.smin.i32(i32 %2, i32 %vec.phi)
  %3 = zext i32 %0 to i64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.smax.nxv4i32(i32 -2147483648, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax = call i32 @llvm.smax.i32(i32 %2, i32 %vec.phi)
  %3 = zext i32 %0 to i64
  %current.iteration.next = add i64 %3, %index
  %avl.next = sub nuw i64 %avl, %3
  %4 = icmp eq i64 %avl.next, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.umin.nxv4i32(i32 -1, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax = call i32 @llvm.umin.i32(i32 %2, i32 %vec.phi)
  %3 = zext i32 %0 to i64
  %current.iteration.next = add i64 %3, %index
  %avl.next = sub nuw i64 %avl, %3
  %4 = icmp eq i64 %avl.next, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds i32, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call i32 @llvm.vp.reduce.umax.nxv4i32(i32 0, <vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax = call i32 @llvm.umax.i32(i32 %2, i32 %vec.phi)
  %3 = zext i32 %0 to i64
  %current.iteration.next = add i64 %3, %index
  %avl.next = sub nuw i64 %avl, %3
  %4 = icmp eq i64 %avl.next, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %current.iteration.next, %vector.body ]
  %vec.phi = phi float [ %start, %vector.ph ], [ %3, %vector.body ]
  %avl = phi i64 [ %n, %vector.ph ], [ %avl.next, %vector.body ]
  %0 = call i32 @llvm.experimental.get.vector.length.i64(i64 %avl, i32 4, i1 true)
  ...
  %2 = call reassoc float @llvm.vp.reduce.fadd.nxv4f32(float -0.000000e+00, <vscale x 4 x float> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %3 = fadd reassoc float %2, %vec.phi
  %4 = zext i32 %0 to i64
  %current.iteration.next = add i64 %4, %index
  %avl.next = sub nuw i64 %avl, %4
  %5 = icmp eq i64 %avl.next, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi float [ %start, %vector.ph ], [ %3, %vector.body ]
  %vec.phi1 = phi float [ 1.000000e+00, %vector.ph ], [ %5, %vector.body ]
  ...
  %wide.load2 = load <4 x float>, ptr %1, align 4
  %2 = call reassoc float @llvm.vector.reduce.fmul.v4f32(float 1.000000e+00, <4 x float> %wide.load)
  %3 = fmul reassoc float %vec.phi, %2
  %4 = call reassoc float @llvm.vector.reduce.fmul.v4f32(float 1.000000e+00, <4 x float> %wide.load2)
  %5 = fmul reassoc float %vec.phi1, %4
  %index.next = add nuw i64 %index, 8
  %6 = icmp eq i64 %index.next, %n.vec
  br i1 %6, label %middle.block, label %vector.body, !llvm.loop !13

middle.block:                                     ; preds = %vector.body
  %bin.rdx = fmul reassoc float %5, %3
  %cmp.n = icmp eq i64 %n, %n.vec
  br i1 %cmp.n, label %for.end, label %scalar.ph

scalar.ph:                                        ; preds = %entry, %middle.block
  %bc.resume.val = phi i64 [ %n.vec, %middle.block ], [ 0, %entry ]
  %bc.merge.rdx = phi float [ %bin.rdx, %middle.block ], [ %start, %entry ]
  br label %for.body
...
for.end:                                          ; preds = %middle.block, %for.body
  %mul.lcssa = phi float [ %mul, %for.body ], [ %bin.rdx, %middle.block ]
  ret float %mul.lcssa
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %current.iteration.next, %vector.body ]
  %vec.phi = phi float [ %start, %vector.ph ], [ %rdx.minmax.select, %vector.body ]
  %avl = phi i64 [ %n, %vector.ph ], [ %avl.next, %vector.body ]
  %0 = call i32 @llvm.experimental.get.vector.length.i64(i64 %avl, i32 4, i1 true)
  %1 = getelementptr inbounds float, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call fast float @llvm.vp.reduce.fmin.nxv4f32(float f0x7F7FFFFF, <vscale x 4 x float> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax.cmp = fcmp fast olt float %2, %vec.phi
  %rdx.minmax.select = select fast i1 %rdx.minmax.cmp, float %2, float %vec.phi
  %3 = zext i32 %0 to i64
  %current.iteration.next = add i64 %3, %index
  %avl.next = sub nuw i64 %avl, %3
  %4 = icmp eq i64 %avl.next, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = getelementptr inbounds float, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %2 = call fast float @llvm.vp.reduce.fmax.nxv4f32(float f0xFF7FFFFF, <vscale x 4 x float> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %rdx.minmax.cmp = fcmp fast ogt float %2, %vec.phi
  %rdx.minmax.select = select fast i1 %rdx.minmax.cmp, float %2, float %vec.phi
  %3 = zext i32 %0 to i64
  %current.iteration.next = add i64 %3, %index
  %avl.next = sub nuw i64 %avl, %3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %current.iteration.next, %vector.body ]
  %vec.phi = phi float [ %start, %vector.ph ], [ %5, %vector.body ]
  %avl = phi i64 [ %n, %vector.ph ], [ %avl.next, %vector.body ]
  %0 = call i32 @llvm.experimental.get.vector.length.i64(i64 %avl, i32 4, i1 true)
  %1 = getelementptr inbounds float, ptr %a, i64 %index
  %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %1, <vscale x 4 x i1> splat (i1 true), i32 %0)
  ...
  %3 = fmul reassoc <vscale x 4 x float> %vp.op.load, %vp.op.load1
  %4 = call reassoc float @llvm.vp.reduce.fadd.nxv4f32(float -0.000000e+00, <vscale x 4 x float> %3, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %5 = fadd reassoc float %4, %vec.phi
  %6 = zext i32 %0 to i64
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.add.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vector.reduce.mul.v4i32(<4 x i32>) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.or.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.and.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.xor.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.smin.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.smin.i32(i32, i32) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.smax.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.smax.i32(i32, i32) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.umin.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.umin.i32(i32, i32) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.umax.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #2
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.vp.reduce.fadd.nxv4f32(float, <vscale x 4 x float>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.vector.reduce.fmul.v4f32(float, <4 x float>) #4

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.vp.reduce.fmin.nxv4f32(float, <vscale x 4 x float>, <vscale x 4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.vp.reduce.fmax.nxv4f32(float, <vscale x 4 x float>, <vscale x 4 x i1>, i32) #2
