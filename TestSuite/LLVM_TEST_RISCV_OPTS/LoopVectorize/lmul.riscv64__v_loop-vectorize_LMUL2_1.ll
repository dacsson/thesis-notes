...
; Variant: riscv64_+v_loop-vectorize_LMUL2_1
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S | FileCheck %s -check-prefix=LMUL2
...
; ModuleID = '/tmp/tmpzowo2lwf.ll'
source_filename = "/tmp/tmpzowo2lwf.ll"
