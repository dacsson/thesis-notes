...
; Variant: riscv32_+v_loop-vectorize_LMUL1
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -force-target-max-vector-interleave=1 -mtriple=riscv32 -mattr=+v -scalable-vectorization=off -S
; Original: RUN: opt < %s -passes=loop-vectorize -force-target-max-vector-interleave=1 -mtriple=riscv32 -mattr=+v -scalable-vectorization=off -S | FileCheck %s --check-prefix=LMUL1
...
; ModuleID = '/tmp/tmpwqccxcm0.ll'
source_filename = "/tmp/tmpwqccxcm0.ll"
