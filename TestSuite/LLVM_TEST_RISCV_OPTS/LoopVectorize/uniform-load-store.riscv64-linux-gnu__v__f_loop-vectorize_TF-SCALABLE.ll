...
; Variant: riscv64-linux-gnu_+v,+f_loop-vectorize_TF-SCALABLE
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -scalable-vectorization=on -riscv-v-vector-bits-min=0 -tail-folding-policy=prefer-fold-tail -mtriple riscv64-linux-gnu -mattr=+v,+f -S
; Original: RUN: opt < %s -passes=loop-vectorize -scalable-vectorization=on -riscv-v-vector-bits-min=0 -tail-folding-policy=prefer-fold-tail -mtriple riscv64-linux-gnu -mattr=+v,+f -S 2>%t | FileCheck %s -check-prefix=TF-SCALABLE
...
; ModuleID = '/tmp/tmpyqqn644p.ll'
source_filename = "/tmp/tmpyqqn644p.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
