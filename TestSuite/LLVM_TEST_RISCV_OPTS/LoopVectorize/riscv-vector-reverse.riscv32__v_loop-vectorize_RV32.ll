...
; Variant: riscv32_+v_loop-vectorize_RV32
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple=riscv32 -mattr=+v -S
; Original: RUN: opt -passes=loop-vectorize -mtriple=riscv32 -mattr=+v -S < %s  | FileCheck --check-prefix=RV32 %s
...
; ModuleID = '/tmp/tmplv1ne083.ll'
source_filename = "/tmp/tmplv1ne083.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %6, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %7 = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %8 = add <vscale x 4 x i32> %7, splat (i32 1)
  %9 = getelementptr inbounds i32, ptr %A, i64 %2
  ...
  %current.iteration.next = add nuw i64 %12, %index
  %avl.next = sub nuw i64 %avl, %12
...
entry:
  %A2 = ptrtoaddr ptr %A to i32
  %B1 = ptrtoaddr ptr %B to i32
  %cmp7 = icmp sgt i32 %n, 0
  br i1 %cmp7, label %for.body.preheader, label %for.cond.cleanup
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %11 = sub nuw nsw i32 %5, 1
  %12 = sub i32 0, %11
  %13 = getelementptr i32, ptr %10, i32 %12
  %vp.op.load = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 %13, <vscale x 4 x i1> splat (i1 true), i32 %5)
  %14 = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %5)
  %15 = add <vscale x 4 x i32> %14, splat (i32 1)
  %16 = getelementptr inbounds i32, ptr %A, i64 %9
  %17 = getelementptr i32, ptr %16, i32 %12
  %18 = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> %15, <vscale x 4 x i1> splat (i1 true), i32 %5)
  call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> %18, ptr align 4 %17, <vscale x 4 x i1> splat (i1 true), i32 %5)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = add nsw i32 %7, -1
  %9 = zext i32 %8 to i64
  %10 = getelementptr inbounds float, ptr %B, i64 %9
  %11 = sub nuw nsw i32 %5, 1
  %12 = sub i32 0, %11
  %13 = getelementptr float, ptr %10, i32 %12
  %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %13, <vscale x 4 x i1> splat (i1 true), i32 %5)
  %14 = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %5)
  %15 = fadd <vscale x 4 x float> %14, splat (float 1.000000e+00)
  %16 = getelementptr inbounds float, ptr %A, i64 %9
  %17 = getelementptr float, ptr %16, i32 %12
  %18 = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> %15, <vscale x 4 x i1> splat (i1 true), i32 %5)
  call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> %18, ptr align 4 %17, <vscale x 4 x i1> splat (i1 true), i32 %5)
  %19 = zext i32 %5 to i64
  %current.iteration.next = add nuw i64 %19, %index
  %avl.next = sub nuw i64 %avl, %19
  %20 = icmp eq i64 %avl.next, 0
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %conv1 = fadd float %21, 1.000000e+00
  %arrayidx3 = getelementptr inbounds float, ptr %A, i64 %idxprom
  store float %conv1, ptr %arrayidx3, align 4
  %cmp = icmp ugt i64 %indvars.iv, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = sub nuw nsw i32 %0, 1
  %5 = sub i32 0, %4
  %6 = getelementptr float, ptr %3, i32 %5
  %vp.op.load = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 %6, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %7 = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> %vp.op.load, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %8 = fadd <vscale x 4 x float> %7, splat (float 1.000000e+00)
  %9 = getelementptr inbounds float, ptr %A, i64 %2
  %10 = getelementptr float, ptr %9, i32 %5
  %11 = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> %8, <vscale x 4 x i1> splat (i1 true), i32 %0)
  call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> %11, ptr align 4 %10, <vscale x 4 x i1> splat (i1 true), i32 %0)
  %12 = zext i32 %0 to i64
  %current.iteration.next = add nuw i64 %12, %index
  %avl.next = sub nuw i64 %avl, %12
  %13 = icmp eq i64 %avl.next, 0
