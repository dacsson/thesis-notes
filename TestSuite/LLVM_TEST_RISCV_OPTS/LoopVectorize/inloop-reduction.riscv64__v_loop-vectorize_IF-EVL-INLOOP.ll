...
; Original: RUN: opt -passes=loop-vectorize -prefer-inloop-reductions -tail-folding-policy=prefer-fold-tail -mtriple=riscv64 -mattr=+v -S < %s 2>&1 | FileCheck --check-prefix=IF-EVL-INLOOP %s
...
; ModuleID = '/tmp/tmp5vi_14uw.ll'
source_filename = "/tmp/tmp5vi_14uw.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %0 = call i32 @llvm.experimental.get.vector.length.i32(i32 %avl, i32 8, i1 true)
  ...
  %2 = sext <vscale x 8 x i16> %vp.op.load to <vscale x 8 x i32>
  %3 = call i32 @llvm.vp.reduce.add.nxv8i32(i32 0, <vscale x 8 x i32> %2, <vscale x 8 x i1> splat (i1 true), i32 %0)
  %4 = add i32 %3, %vec.phi
  %current.iteration.next = add nuw i32 %0, %index
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  %r.0.lcssa = phi i32 [ 0, %entry ], [ %4, %for.cond.cleanup.loopexit ]
  ret i32 %r.0.lcssa
}
...
declare <vscale x 8 x i16> @llvm.vp.load.nxv8i16.p0(ptr captures(none), <vscale x 8 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.add.nxv8i32(i32, <vscale x 8 x i32>, <vscale x 8 x i1>, i32) #1
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vp.reduce.smin.nxv4i32(i32, <vscale x 4 x i32>, <vscale x 4 x i1>, i32) #1
