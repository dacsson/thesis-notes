...
; Variant: riscv64_"+v,+zvfh"_loop-vectorize
; Command: /home/artjom/Tools/llvm-project/build/bin/opt --passes=loop-vectorize --mtriple=riscv64 -mattr="+v,+zvfh" -S
; Original: RUN: opt --passes=loop-vectorize --mtriple=riscv64 -mattr="+v,+zvfh" -S < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpka3tpogv.ll'
source_filename = "/tmp/tmpka3tpogv.ll"
