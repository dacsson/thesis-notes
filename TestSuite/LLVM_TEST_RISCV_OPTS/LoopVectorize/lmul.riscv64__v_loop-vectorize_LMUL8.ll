...
; Variant: riscv64_+v_loop-vectorize_LMUL8
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=loop-vectorize -mtriple riscv64 -mattr=+v --riscv-v-register-bit-width-lmul=8 -S
; Original: RUN: opt < %s -passes=loop-vectorize -mtriple riscv64 -mattr=+v -S --riscv-v-register-bit-width-lmul=8 | FileCheck %s -check-prefix=LMUL8
...
; ModuleID = '/tmp/tmp1hcpyv91.ll'
source_filename = "/tmp/tmp1hcpyv91.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vp.op.load = call <vscale x 8 x i64> @llvm.vp.load.nxv8i64.p0(ptr align 8 %1, <vscale x 8 x i1> splat (i1 true), i32 %0)
  %2 = add <vscale x 8 x i64> %vp.op.load, splat (i64 1)
  call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> %2, ptr align 8 %1, <vscale x 8 x i1> splat (i1 true), i32 %0)
  %3 = zext i32 %0 to i64
