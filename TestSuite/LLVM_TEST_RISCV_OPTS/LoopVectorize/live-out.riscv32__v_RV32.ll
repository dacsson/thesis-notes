...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -p loop-vectorize -mtriple riscv32 -mattr=+v -vplan-verify-each -S
; Original: RUN: opt < %s -S -p loop-vectorize -mtriple riscv32 -mattr=+v -vplan-verify-each | FileCheck %s --check-prefix=RV32
...
; ModuleID = '/tmp/tmpx23vdiix.ll'
source_filename = "/tmp/tmpx23vdiix.ll"
