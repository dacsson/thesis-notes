...
; ModuleID = '/tmp/tmpqidxjz4b.ll'
source_filename = "/tmp/tmpqidxjz4b.ll"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <vscale x 4 x i32>, ptr %4, align 4, !alias.scope !0
  %5 = call i32 @llvm.vector.reduce.add.nxv4i32(<vscale x 4 x i32> %wide.load)
  %6 = add i32 %vec.phi, %5
...
middle.block:                                     ; preds = %vector.body
  store i32 %6, ptr %addr, align 4, !alias.scope !6, !noalias !0
...
scalar.ph:                                        ; preds = %vector.memcheck, %entry, %middle.block
  ...
  %bc.merge.rdx = phi i32 [ %6, %middle.block ], [ %start, %entry ], [ %start, %vector.memcheck ]
  br label %for.body
