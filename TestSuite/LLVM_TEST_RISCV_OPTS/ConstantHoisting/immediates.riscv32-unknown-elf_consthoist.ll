...
; Variant: riscv32-unknown-elf_consthoist
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32-unknown-elf -passes=consthoist -S
; Original: RUN: opt -mtriple=riscv32-unknown-elf -S -passes=consthoist < %s | FileCheck %s -check-prefixes=CHECK,RV32I
...
; ModuleID = '/tmp/tmpgjj3jpjz.ll'
source_filename = "/tmp/tmpgjj3jpjz.ll"
