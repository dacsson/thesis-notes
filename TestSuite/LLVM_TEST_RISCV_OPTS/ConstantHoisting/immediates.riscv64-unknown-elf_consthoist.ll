; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/ConstantHoisting/RISCV/immediates.ll
; Variant: riscv64-unknown-elf_consthoist
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64-unknown-elf -passes=consthoist -S
; Original: RUN: opt -mtriple=riscv64-unknown-elf -S -passes=consthoist < %s | FileCheck %s -check-prefixes=CHECK,RV64I
...
; ModuleID = '/tmp/tmpeptef6sx.ll'
source_filename = "/tmp/tmpeptef6sx.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-unknown-elf"

; Function Attrs: nounwind
define i64 @test1(i64 %a) #0 {
  %1 = mul i64 %a, 2
  %2 = add i64 %1, 2
  ret i64 %2
}
...
; Function Attrs: nounwind
define i64 @test3(i64 %a) #0 {
  %const = bitcast i64 32766 to i64
  %1 = mul i64 %a, %const
  %2 = add i64 %1, %const
  ret i64 %2
}
...
; Function Attrs: nounwind
define i64 @test7(i64 %a) #0 {
  %const = bitcast i64 4294967295 to i64
  %1 = and i64 %a, %const
  %2 = and i64 %1, %const
  ret i64 %2
}
...
; Function Attrs: nounwind
define i32 @test10(i32 %a, i32 %b) #0 {
  %1 = shl i32 %a, 8
  %2 = and i32 %1, 65280
  %3 = shl i32 %b, 8
  %4 = and i32 %3, 65280
...
; Function Attrs: nounwind
define i64 @test11(i64 %a) #3 {
  %1 = or i64 %a, 8589934592
  %2 = or i64 %1, 8589934592
  ret i64 %2
}

; Function Attrs: nounwind
define i64 @test12(i64 %a) #3 {
...
; Function Attrs: nounwind
define i64 @test13(i64 %a) #3 {
  %1 = and i64 %a, -281474976710657
  %2 = and i64 %1, -281474976710657
  ret i64 %2
}

; Function Attrs: nounwind
define i64 @test14(i64 %a) #0 {
  %1 = mul i64 %a, 2048
  %2 = mul i64 %1, 2048
  ret i64 %2
}
...
; Function Attrs: nounwind
define void @test17(ptr %s, i32 %size) #0 {
entry:
  %const = bitcast i32 -1073741792 to i32
  %cond = icmp eq i32 %size, 0
  br i1 %cond, label %if.true, label %exit

if.true:                                          ; preds = %entry
  %0 = inttoptr i32 %const to ptr
  store i32 20, ptr %0, align 4
  br label %exit

exit:                                             ; preds = %if.true, %entry
  %1 = inttoptr i32 %const to ptr
  store i32 10, ptr %1, align 4
  ret void
}

; Function Attrs: nounwind
define i32 @test18(ptr %s, i32 %size) #0 {
entry:
  %const = bitcast i32 -1073741792 to i32
  %cond = icmp eq i32 %size, 0
  br i1 %cond, label %if.true, label %if.false
...
if.false:                                         ; preds = %entry
  %2 = inttoptr i32 %const to ptr
  %3 = load i32, ptr %2, align 4
  br label %return

return:                                           ; preds = %if.false, %if.true
  %val = phi i32 [ %1, %if.true ], [ %3, %if.false ]
  ret i32 %val
}

; Function Attrs: nounwind
define void @test19(ptr %s, i32 %size) #0 {
entry:
  %cond = icmp eq i32 %size, 0
  br i1 %cond, label %if.true, label %exit

if.true:                                          ; preds = %entry
  store i32 20, ptr inttoptr (i32 2044 to ptr), align 4
  br label %exit

exit:                                             ; preds = %if.true, %entry
  store i32 10, ptr inttoptr (i32 2044 to ptr), align 4
  ret void
}

define void @test20(ptr %p1, ptr %p2) {
  %const = bitcast i32 15111111 to i32
  store i32 %const, ptr %p1, align 4
  %const_mat = add i32 %const, 1
  store i32 %const_mat, ptr %p2, align 4
  ret void
}
...
attributes #1 = { nounwind "target-features"="+zbb" }
attributes #2 = { nounwind "target-features"="+zba" }
attributes #3 = { nounwind "target-features"="+zbs" }
