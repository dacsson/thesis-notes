; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SimplifyCFG/RISCV/select-trunc-i64.ll
; Variant: riscv32_simplifycfg
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -mtriple=riscv32 -S
; Original: RUN: opt -S -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -mtriple=riscv32 < %s | FileCheck %s
...
; ModuleID = '/tmp/tmp0i8owjpv.ll'
source_filename = "/tmp/tmp0i8owjpv.ll"
...
entry:
  ...
  %cond = select i1 %0, i64 %add, i64 -2147483648
  %extract.t = trunc i64 %cond to i32
  %cond8.off0 = select i1 %cmp, i32 2147483647, i32 %extract.t
  ret i32 %cond8.off0
}
