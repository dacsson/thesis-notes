; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/SimplifyCFG/RISCV/switch_to_lookup_table-rv64.ll
; Variant: +f_simplifycfg<no-keep-loops;switch-to-lookup>
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes='simplifycfg<no-keep-loops;switch-to-lookup>' -mattr=+f -S
; Original: RUN: opt < %s -passes='simplifycfg<no-keep-loops;switch-to-lookup>' -S -mattr=+f | FileCheck %s
...
; ModuleID = '/tmp/tmp45r5_edi.ll'
source_filename = "/tmp/tmp45r5_edi.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64-unknown-elf"
...
@switch.table.foostring = private unnamed_addr constant [4 x ptr] [ptr @.str, ptr @.str1, ptr @.str2, ptr @.str3], align 8
...
switch.lookup:                                    ; preds = %entry
  %1 = zext nneg i32 %switch.tableidx to i64
  %switch.gep = getelementptr inbounds [9 x i8], ptr @switch.table.char, i64 0, i64 %1
...
switch.lookup:                                    ; preds = %entry
  ...
  %switch.gep = getelementptr inbounds [4 x float], ptr @switch.table.h, i64 0, i64 %1
...
switch.lookup:                                    ; preds = %entry
  %1 = zext nneg i32 %x to i64
  %switch.gep = getelementptr inbounds [4 x ptr], ptr @switch.table.foostring, i64 0, i64 %1
