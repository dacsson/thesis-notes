...
; Variant: riscv32_+v_interleaved-access_RV32
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+v -passes=interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv32 -mattr=+v -passes=interleaved-access -S | FileCheck %s --check-prefix=RV32
...
; ModuleID = '/tmp/tmpm4_j3uce.ll'
source_filename = "/tmp/tmpm4_j3uce.ll"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32"

define void @load_factor2(ptr %ptr) #0 {
  %1 = call { <8 x i32>, <8 x i32> } @llvm.riscv.seg2.load.mask.v8i32.p0.i32(ptr %ptr, <8 x i1> splat (i1 true), i32 8)
...
define void @load_factor2_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 32 x i8>, 2) @llvm.riscv.vlseg2.mask.triscv.vector.tuple_nxv32i8_2t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 32 x i8>, 2) poison, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor3(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg3.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor3_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 8 x i8>, 3) @llvm.riscv.vlseg3.mask.triscv.vector.tuple_nxv8i8_3t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 3) poison, ptr %ptr, <vscale x 2 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor4(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg4.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor4_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 16 x i8>, 4) @llvm.riscv.vlseg4.mask.triscv.vector.tuple_nxv16i8_4t.p0.nxv4i1.i32(target("riscv.vector.tuple", <vscale x 16 x i8>, 4) poison, ptr %ptr, <vscale x 4 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor5(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg5.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor5_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 8 x i8>, 5) @llvm.riscv.vlseg5.mask.triscv.vector.tuple_nxv8i8_5t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 5) poison, ptr %ptr, <vscale x 2 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor6(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg6.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor6_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 8 x i8>, 6) @llvm.riscv.vlseg6.mask.triscv.vector.tuple_nxv8i8_6t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 6) poison, ptr %ptr, <vscale x 2 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor7(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg7.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor7_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 8 x i8>, 7) @llvm.riscv.vlseg7.mask.triscv.vector.tuple_nxv8i8_7t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 7) poison, ptr %ptr, <vscale x 2 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @load_factor8(ptr %ptr) #0 {
  %1 = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg8.load.mask.v4i32.p0.i32(ptr %ptr, <4 x i1> splat (i1 true), i32 4)
...
define void @load_factor8_vscale(ptr %ptr) #0 {
  %1 = call target("riscv.vector.tuple", <vscale x 8 x i8>, 8) @llvm.riscv.vlseg8.mask.triscv.vector.tuple_nxv8i8_8t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 8) poison, ptr %ptr, <vscale x 2 x i1> splat (i1 true), i32 -1, i32 3, i32 5)
...
define void @store_factor2(ptr %ptr, <8 x i8> %v0, <8 x i8> %v1) #0 {
  ...
  call void @llvm.riscv.seg2.store.mask.v8i8.p0.i32(<8 x i8> %1, <8 x i8> %2, ptr %ptr, <8 x i1> splat (i1 true), i32 8)
  ret void
}
...
define void @store_factor2_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1) #0 {
  ...
  call void @llvm.riscv.vsseg2.mask.triscv.vector.tuple_nxv8i8_2t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 2) %2, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor3(ptr %ptr, <4 x i32> %v0, <4 x i32> %v1, <4 x i32> %v2) #0 {
  ...
  call void @llvm.riscv.seg3.store.mask.v4i32.p0.i32(<4 x i32> %1, <4 x i32> %2, <4 x i32> %3, ptr %ptr, <4 x i1> splat (i1 true), i32 4)
  ret void
}
...
define void @store_factor3_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2) #0 {
  ...
  call void @llvm.riscv.vsseg3.mask.triscv.vector.tuple_nxv8i8_3t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 3) %3, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor4(ptr %ptr, <4 x i32> %v0, <4 x i32> %v1, <4 x i32> %v2, <4 x i32> %v3) #0 {
  ...
  call void @llvm.riscv.seg4.store.mask.v4i32.p0.i32(<4 x i32> %1, <4 x i32> %2, <4 x i32> %3, <4 x i32> %4, ptr %ptr, <4 x i1> splat (i1 true), i32 4)
  ret void
}
...
define void @store_factor4_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2, <vscale x 8 x i8> %v3) #0 {
  ...
  call void @llvm.riscv.vsseg4.mask.triscv.vector.tuple_nxv8i8_4t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 4) %4, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor5_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2, <vscale x 8 x i8> %v3, <vscale x 8 x i8> %v4) #0 {
  ...
  call void @llvm.riscv.vsseg5.mask.triscv.vector.tuple_nxv8i8_5t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 5) %5, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor2_wide(ptr %ptr, <8 x i32> %v0, <8 x i32> %v1) #0 {
  ...
  call void @llvm.riscv.seg2.store.mask.v8i32.p0.i32(<8 x i32> %1, <8 x i32> %2, ptr %ptr, <8 x i1> splat (i1 true), i32 8)
  ret void
}
...
define void @store_factor3_wide(ptr %ptr, <8 x i32> %v0, <8 x i32> %v1, <8 x i32> %v2) #0 {
  ...
  call void @llvm.riscv.seg3.store.mask.v8i32.p0.i32(<8 x i32> %1, <8 x i32> %2, <8 x i32> %3, ptr %ptr, <8 x i1> splat (i1 true), i32 8)
  ret void
}
...
define void @store_factor4_wide(ptr %ptr, <8 x i32> %v0, <8 x i32> %v1, <8 x i32> %v2, <8 x i32> %v3) #0 {
  ...
  call void @llvm.riscv.seg4.store.mask.v8i32.p0.i32(<8 x i32> %1, <8 x i32> %2, <8 x i32> %3, <8 x i32> %4, ptr %ptr, <8 x i1> splat (i1 true), i32 8)
  ret void
}
...
define void @store_factor6_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2, <vscale x 8 x i8> %v3, <vscale x 8 x i8> %v4, <vscale x 8 x i8> %v5) #0 {
  ...
  call void @llvm.riscv.vsseg6.mask.triscv.vector.tuple_nxv8i8_6t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 6) %6, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor7_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2, <vscale x 8 x i8> %v3, <vscale x 8 x i8> %v4, <vscale x 8 x i8> %v5, <vscale x 8 x i8> %v6) #0 {
  ...
  call void @llvm.riscv.vsseg7.mask.triscv.vector.tuple_nxv8i8_7t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 7) %7, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @store_factor8_vscale(ptr %ptr, <vscale x 8 x i8> %v0, <vscale x 8 x i8> %v1, <vscale x 8 x i8> %v2, <vscale x 8 x i8> %v3, <vscale x 8 x i8> %v4, <vscale x 8 x i8> %v5, <vscale x 8 x i8> %v6, <vscale x 8 x i8> %v7) #0 {
  ...
  call void @llvm.riscv.vsseg8.mask.triscv.vector.tuple_nxv8i8_8t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 8) %8, ptr %ptr, <vscale x 8 x i1> splat (i1 true), i32 -1, i32 3)
  ret void
}
...
define void @load_factor2_f32(ptr %ptr) #0 {
  %1 = call { <8 x float>, <8 x float> } @llvm.riscv.seg2.load.mask.v8f32.p0.i32(ptr %ptr, <8 x i1> splat (i1 true), i32 8)
...
define void @load_factor2_f64(ptr %ptr) #0 {
  %1 = call { <8 x double>, <8 x double> } @llvm.riscv.seg2.load.mask.v8f64.p0.i32(ptr %ptr, <8 x i1> splat (i1 true), i32 8)
...
declare { <8 x i32>, <8 x i32> } @llvm.riscv.seg2.load.mask.v8i32.p0.i32(ptr captures(none), <8 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 32 x i8>, 2) @llvm.riscv.vlseg2.mask.triscv.vector.tuple_nxv32i8_2t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 32 x i8>, 2), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg3.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 8 x i8>, 3) @llvm.riscv.vlseg3.mask.triscv.vector.tuple_nxv8i8_3t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 3), ptr captures(none), <vscale x 2 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg4.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 16 x i8>, 4) @llvm.riscv.vlseg4.mask.triscv.vector.tuple_nxv16i8_4t.p0.nxv4i1.i32(target("riscv.vector.tuple", <vscale x 16 x i8>, 4), ptr captures(none), <vscale x 4 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg5.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 8 x i8>, 5) @llvm.riscv.vlseg5.mask.triscv.vector.tuple_nxv8i8_5t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 5), ptr captures(none), <vscale x 2 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg6.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 8 x i8>, 6) @llvm.riscv.vlseg6.mask.triscv.vector.tuple_nxv8i8_6t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 6), ptr captures(none), <vscale x 2 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg7.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 8 x i8>, 7) @llvm.riscv.vlseg7.mask.triscv.vector.tuple_nxv8i8_7t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 7), ptr captures(none), <vscale x 2 x i1>, i32, i32 immarg, i32 immarg) #3
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.riscv.seg8.load.mask.v4i32.p0.i32(ptr captures(none), <4 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: read)
declare target("riscv.vector.tuple", <vscale x 8 x i8>, 8) @llvm.riscv.vlseg8.mask.triscv.vector.tuple_nxv8i8_8t.p0.nxv2i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 8), ptr captures(none), <vscale x 2 x i1>, i32, i32 immarg, i32 immarg) #3
...
declare void @llvm.riscv.seg2.store.mask.v8i8.p0.i32(<8 x i8>, <8 x i8>, ptr captures(none), <8 x i1>, i32) #5
...
declare void @llvm.riscv.vsseg2.mask.triscv.vector.tuple_nxv8i8_2t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 2), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
declare void @llvm.riscv.seg3.store.mask.v4i32.p0.i32(<4 x i32>, <4 x i32>, <4 x i32>, ptr captures(none), <4 x i1>, i32) #5
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg3.mask.triscv.vector.tuple_nxv8i8_3t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 3), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
declare void @llvm.riscv.seg4.store.mask.v4i32.p0.i32(<4 x i32>, <4 x i32>, <4 x i32>, <4 x i32>, ptr captures(none), <4 x i1>, i32) #5
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg4.mask.triscv.vector.tuple_nxv8i8_4t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 4), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg5.mask.triscv.vector.tuple_nxv8i8_5t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 5), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
declare void @llvm.riscv.seg2.store.mask.v8i32.p0.i32(<8 x i32>, <8 x i32>, ptr captures(none), <8 x i1>, i32) #5

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
declare void @llvm.riscv.seg3.store.mask.v8i32.p0.i32(<8 x i32>, <8 x i32>, <8 x i32>, ptr captures(none), <8 x i1>, i32) #5

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
declare void @llvm.riscv.seg4.store.mask.v8i32.p0.i32(<8 x i32>, <8 x i32>, <8 x i32>, <8 x i32>, ptr captures(none), <8 x i1>, i32) #5
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg6.mask.triscv.vector.tuple_nxv8i8_6t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 6), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg7.mask.triscv.vector.tuple_nxv8i8_7t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 7), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: write)
declare void @llvm.riscv.vsseg8.mask.triscv.vector.tuple_nxv8i8_8t.p0.nxv8i1.i32(target("riscv.vector.tuple", <vscale x 8 x i8>, 8), ptr captures(none), <vscale x 8 x i1>, i32, i32 immarg) #6

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <8 x float>, <8 x float> } @llvm.riscv.seg2.load.mask.v8f32.p0.i32(ptr captures(none), <8 x i1>, i32) #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare { <8 x double>, <8 x double> } @llvm.riscv.seg2.load.mask.v8f64.p0.i32(ptr captures(none), <8 x i1>, i32) #2
