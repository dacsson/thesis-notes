...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+v -interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv64 -mattr=+v -interleaved-access -S | FileCheck %s --check-prefix=RV64
...
; ModuleID = '/tmp/tmp27mkz7b7.ll'
source_filename = "/tmp/tmp27mkz7b7.ll"
