...
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+v -interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv32 -mattr=+v -interleaved-access -S | FileCheck %s --check-prefix=RV32
...
; ModuleID = '/tmp/tmpv3lira0x.ll'
source_filename = "/tmp/tmpv3lira0x.ll"
