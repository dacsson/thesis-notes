...
; Variant: riscv64_+zve64x,+zvl128b_ZVE64X
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+zve64x,+zvl128b -interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv64 -mattr=+zve64x,+zvl128b -interleaved-access -S | FileCheck %s -check-prefix=ZVE64X
...
; ModuleID = '/tmp/tmp1hh9kfmm.ll'
source_filename = "/tmp/tmp1hh9kfmm.ll"
