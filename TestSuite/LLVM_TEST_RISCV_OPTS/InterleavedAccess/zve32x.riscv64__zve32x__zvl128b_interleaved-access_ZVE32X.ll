...
; Variant: riscv64_+zve32x,+zvl128b_interleaved-access_ZVE32X
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv64 -mattr=+zve32x,+zvl128b -passes=interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv64 -mattr=+zve32x,+zvl128b -passes=interleaved-access -S | FileCheck %s -check-prefix=ZVE32X
...
; ModuleID = '/tmp/tmpwtw_rbso.ll'
source_filename = "/tmp/tmpwtw_rbso.ll"
