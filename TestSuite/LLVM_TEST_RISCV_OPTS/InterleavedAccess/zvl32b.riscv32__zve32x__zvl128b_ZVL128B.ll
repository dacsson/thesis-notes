...
; Variant: riscv32_+zve32x,+zvl128b_ZVL128B
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+zve32x,+zvl128b -interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv32 -mattr=+zve32x,+zvl128b -interleaved-access -S | FileCheck %s -check-prefix=ZVL128B
...
; ModuleID = '/tmp/tmpzmrp7tqa.ll'
source_filename = "/tmp/tmpzmrp7tqa.ll"
