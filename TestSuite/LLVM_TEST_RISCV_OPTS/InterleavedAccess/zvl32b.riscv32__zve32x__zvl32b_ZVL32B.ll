...
; Variant: riscv32_+zve32x,+zvl32b_ZVL32B
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -mtriple=riscv32 -mattr=+zve32x,+zvl32b -interleaved-access -S
; Original: RUN: opt < %s -mtriple=riscv32 -mattr=+zve32x,+zvl32b -interleaved-access -S | FileCheck %s -check-prefix=ZVL32B
...
; ModuleID = '/tmp/tmpxqakkwm9.ll'
source_filename = "/tmp/tmpxqakkwm9.ll"
