; Source: /home/artjom/Tools/llvm-project/llvm/test/Transforms/InstCombine/RISCV/riscv-vsetvli-knownbits.ll
; Variant: instcombine
...
; ModuleID = '/tmp/tmpe21lf1a8.ll'
source_filename = "/tmp/tmpe21lf1a8.ll"

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare i32 @llvm.riscv.vsetvli.i32(i32, i32 immarg, i32 immarg) #0

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare i64 @llvm.riscv.vsetvli.i64(i64, i64 immarg, i64 immarg) #0

; Function Attrs: nounwind vscale_range(2,1024)
define i32 @vsetvli_i32() #1 {
entry:
  %0 = call i32 @llvm.riscv.vsetvli.i32(i32 1, i32 1, i32 1)
  ret i32 %0
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define signext i32 @vsetvl_sext() #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 1, i64 1, i64 1)
  %b = trunc nuw nsw i64 %a to i32
  ret i32 %b
}

; Function Attrs: nounwind vscale_range(2,1024)
define zeroext i32 @vsetvl_zext() #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 1, i64 1, i64 1)
  %b = trunc nuw nsw i64 %a to i32
  ret i32 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i32 @vsetvli_and17_i32() #1 {
entry:
  %0 = call i32 @llvm.riscv.vsetvli.i32(i32 1, i32 1, i32 1)
  ret i32 %0
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvli_and17_i64() #1 {
entry:
  %0 = call i64 @llvm.riscv.vsetvli.i64(i64 1, i64 1, i64 1)
  ret i64 %0
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m1_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 0)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m1_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 0)
  %b = and i64 %a, 8191
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m1_constant_avl() #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 1, i64 0, i64 0)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m2_and15bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 1)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m2_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 1)
  %b = and i64 %a, 16383
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m4_and16bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 2)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m4_and15bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 2)
  %b = and i64 %a, 32767
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m8_and17bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 3)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8m8_and16bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 3)
  %b = and i64 %a, 65535
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf2_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 5)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf2_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 5)
  %b = and i64 %a, 1023
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf4_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 6)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf4_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 6)
  %b = and i64 %a, 2047
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf8_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 7)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e8mf8_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 0, i64 7)
  %b = and i64 %a, 4095
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m1_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 0)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m1_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 0)
  %b = and i64 %a, 4095
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m2_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 1)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m2_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 1)
  %b = and i64 %a, 8191
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m4_and15bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 2)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m4_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 2)
  %b = and i64 %a, 16383
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m8_and16bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 3)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16m8_and15bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 3)
  %b = and i64 %a, 32767
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf2_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 5)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf2_and9bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 5)
  %b = and i64 %a, 511
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf4_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 6)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf4_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 6)
  %b = and i64 %a, 1023
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf8_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 7)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e16mf8_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 1, i64 7)
  %b = and i64 %a, 2047
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m1_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 0)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m1_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 0)
  %b = and i64 %a, 2047
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m2_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 1)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m2_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 1)
  %b = and i64 %a, 4095
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m4_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 2)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m4_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 2)
  %b = and i64 %a, 8191
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m8_and15bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 3)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32m8_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 3)
  %b = and i64 %a, 16383
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf2_and9bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 5)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf2_and8bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 5)
  %b = and i64 %a, 255
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf4_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 6)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf4_and9bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 6)
  %b = and i64 %a, 511
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf8_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 7)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e32mf8_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 2, i64 7)
  %b = and i64 %a, 1023
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m1_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 0)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m1_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 0)
  %b = and i64 %a, 1023
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m2_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 1)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m2_and11bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 1)
  %b = and i64 %a, 2047
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m4_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 2)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m4_and12bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 2)
  %b = and i64 %a, 4095
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m8_and14bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 3)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64m8_and13bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 3)
  %b = and i64 %a, 8191
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf2_and8bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 5)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf2_and7bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 5)
  %b = and i64 %a, 127
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf4_and9bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 6)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf4_and8bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 6)
  %b = and i64 %a, 255
  ret i64 %b
}
...
; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf8_and10bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 7)
  ret i64 %a
}

; Function Attrs: nounwind vscale_range(2,1024)
define i64 @vsetvl_e64mf8_and9bits(i64 %avl) #1 {
  %a = call i64 @llvm.riscv.vsetvli.i64(i64 %avl, i64 3, i64 7)
  %b = and i64 %a, 511
  ret i64 %b
}
