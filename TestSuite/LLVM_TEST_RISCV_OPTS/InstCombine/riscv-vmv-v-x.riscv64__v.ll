...
; Variant: riscv64_+v
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -p instcombine -mtriple=riscv64 -mattr=+v -S
; Original: RUN: opt -p instcombine -mtriple=riscv64 -mattr=+v -S %s | FileCheck %s --check-prefixes=CHECK,RV64
...
; ModuleID = '/tmp/tmp3sievaow.ll'
source_filename = "/tmp/tmp3sievaow.ll"
...
define <vscale x 1 x i64> @vector_elt_type_legality() #0 {
  %1 = call <vscale x 1 x i64> @llvm.riscv.vmv.v.x.nxv1i64.i64(<vscale x 1 x i64> poison, i64 6148914691236517205, i64 1)
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <vscale x 1 x i64> @llvm.riscv.vmv.v.x.nxv1i64.i64(<vscale x 1 x i64>, i64, i64) #2
