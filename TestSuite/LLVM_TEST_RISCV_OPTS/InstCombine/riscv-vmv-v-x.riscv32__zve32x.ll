...
; Variant: riscv32_+zve32x
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -p instcombine -mtriple=riscv32 -mattr=+zve32x -S
; Original: RUN: opt -p instcombine -mtriple=riscv32 -mattr=+zve32x -S %s | FileCheck %s --check-prefixes=CHECK,ZVE32X
...
; ModuleID = '/tmp/tmph6ao4_vr.ll'
source_filename = "/tmp/tmph6ao4_vr.ll"
...
attributes #1 = { nocallback nofree nosync nounwind willreturn memory(none) "target-features"="+zve32x" }
