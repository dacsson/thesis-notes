...
; Variant: riscv64_+zve32x
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -p instcombine -mtriple=riscv64 -mattr=+zve32x -S
; Original: RUN: opt -p instcombine -mtriple=riscv64 -mattr=+zve32x -S %s | FileCheck %s --check-prefixes=CHECK,ZVE32X
...
; ModuleID = '/tmp/tmpq1_92pfi.ll'
source_filename = "/tmp/tmpq1_92pfi.ll"
