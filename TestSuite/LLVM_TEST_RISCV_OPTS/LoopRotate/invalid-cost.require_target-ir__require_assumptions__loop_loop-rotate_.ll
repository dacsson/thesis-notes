...
; Variant: require<target-ir>,require<assumptions>,loop(loop-rotate)
; Command: /home/artjom/Tools/llvm-project/build/bin/opt -passes='require<target-ir>,require<assumptions>,loop(loop-rotate)' -S
; Original: RUN: opt -S -passes='require<target-ir>,require<assumptions>,loop(loop-rotate)' < %s | FileCheck %s
...
; ModuleID = '/tmp/tmpetdlxq0w.ll'
source_filename = "/tmp/tmpetdlxq0w.ll"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128"
target triple = "riscv64-unknown-unknown"
