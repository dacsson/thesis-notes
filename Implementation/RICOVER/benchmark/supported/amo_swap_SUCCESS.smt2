...
(rule
  (forall ((regs0 (Array (_ BitVec 5) (_ BitVec 64))) (mem0 (Array (_ BitVec 64) (_ BitVec 8))) (pc0 (_ BitVec 64))
    ...
    (=> (and
          ; amoswap.w a0, a1, 0(a2)
          (amoswap_4 regs0 mem0 pc0 regs1 mem1 pc1 (_ bv11 5) (_ bv12 5) reg_a0)
          ; ret
          (jalr regs1 mem1 pc1 regs2 mem2 pc2 (_ bv0 12) reg_ra reg_zero)
        )
        (amo_swap_SUCCESS1 regs0 mem0 pc0 regs2 mem2 pc2))))

(declare-rel amo_swap_SUCCESS2
  ((Array (_ BitVec 5) (_ BitVec 64)) (Array (_ BitVec 64) (_ BitVec 8)) (_ BitVec 64)
   (Array (_ BitVec 5) (_ BitVec 64)) (Array (_ BitVec 64) (_ BitVec 8)) (_ BitVec 64)))
...
(rule
  (forall ((regs0 (Array (_ BitVec 5) (_ BitVec 64))) (mem0 (Array (_ BitVec 64) (_ BitVec 8))) (pc0 (_ BitVec 64))
    ...
    (=> (and
          ; lw a0, 0(a2)
          (load_4_s regs0 mem0 pc0 regs1 mem1 pc1 (_ bv0 12) (_ bv12 5) reg_a0)
          ; sw a1, 0(a2)
          (store_4 regs1 mem1 pc1 regs2 mem2 pc2 (_ bv0 12) (_ bv11 5) (_ bv12 5))
          ; ret
          (jalr regs2 mem2 pc2 regs3 mem3 pc3 (_ bv0 12) reg_ra reg_zero)
        )
        (amo_swap_SUCCESS2 regs0 mem0 pc0 regs3 mem3 pc3))))
...
(rule
  (forall ((regs0 (Array (_ BitVec 5) (_ BitVec 64)))
    ...
    (=> (and
          ...
          (bvuge sp0 (_ bv0 64))
          (amo_swap_SUCCESS1 regs0 mem0 pc0 regs1 mem1 pc1)
          (amo_swap_SUCCESS2 regs0 mem0 pc0 regs2 mem2 pc2)
