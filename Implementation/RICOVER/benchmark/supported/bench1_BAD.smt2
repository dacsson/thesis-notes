...
(rule
  (forall ((regs0 (Array (_ BitVec 5) (_ BitVec 64))) (mem0 (Array (_ BitVec 64) (_ BitVec 8))) (pc0 (_ BitVec 64))
    ...
    (=> (and
          ; slli a2, a0, 56
          (slli regs0 mem0 pc0 regs1 mem1 pc1 (_ bv56 6) reg_a0 (_ bv12 5))
          ; sll a0, a0, a1
          (sll regs1 mem1 pc1 regs2 mem2 pc2 (_ bv11 5) reg_a0 reg_a0)
          ; srai a2, a2, 56
          (srai regs2 mem2 pc2 regs3 mem3 pc3 (_ bv56 6) (_ bv12 5) (_ bv12 5))
          ; zext.b a0, a0
          (andi regs3 mem3 pc3 regs4 mem4 pc4 (_ bv255 12) reg_a0 reg_a0)
          ; srl a0, a0, a1
          (srl regs4 mem4 pc4 regs5 mem5 pc5 (_ bv11 5) reg_a0 reg_a0)
          ; slli a0, a0, 56
          (slli regs5 mem5 pc5 regs6 mem6 pc6 (_ bv56 6) reg_a0 reg_a0)
          ; srai a0, a0, 56
          (srai regs6 mem6 pc6 regs7 mem7 pc7 (_ bv56 6) reg_a0 reg_a0)
          ; slt a0, a0, a2
          (slt regs7 mem7 pc7 regs8 mem8 pc8 (_ bv12 5) reg_a0 reg_a0)
          ; xori a0, a0, 1
          (xori regs8 mem8 pc8 regs9 mem9 pc9 (_ bv1 12) reg_a0 reg_a0)
          ; ret
          (jalr regs9 mem9 pc9 regs10 mem10 pc10 (_ bv0 12) reg_ra reg_zero)
        )
        (bench1_BAD1 regs0 mem0 pc0 regs10 mem10 pc10))))
...
(rule
  (forall ((regs0 (Array (_ BitVec 5) (_ BitVec 64))) (mem0 (Array (_ BitVec 64) (_ BitVec 8))) (pc0 (_ BitVec 64))
    ...
    (=> (and
          ; slli a0, a0, 56
          (slli regs0 mem0 pc0 regs1 mem1 pc1 (_ bv56 6) reg_a0 reg_a0)
          ; li a2, 255
          (addi regs1 mem1 pc1 regs2 mem2 pc2 (_ bv255 12) reg_zero (_ bv12 5))
          ; srai a0, a0, 56
          (srai regs2 mem2 pc2 regs3 mem3 pc3 (_ bv56 6) reg_a0 reg_a0)
          ; srl a1, a2, a1
          (srl regs3 mem3 pc3 regs4 mem4 pc4 (_ bv11 5) (_ bv12 5) (_ bv11 5))
          ; slli a1, a1, 56
          (slli regs4 mem4 pc4 regs5 mem5 pc5 (_ bv56 6) (_ bv11 5) (_ bv11 5))
          ; srai a1, a1, 56
          (srai regs5 mem5 pc5 regs6 mem6 pc6 (_ bv56 6) (_ bv11 5) (_ bv11 5))
          ; slt a0, a1, a0
          (slt regs6 mem6 pc6 regs7 mem7 pc7 reg_a0 (_ bv11 5) reg_a0)
          ; xori a0, a0, 1
          (xori regs7 mem7 pc7 regs8 mem8 pc8 (_ bv1 12) reg_a0 reg_a0)
          ; ret
          (jalr regs8 mem8 pc8 regs9 mem9 pc9 (_ bv0 12) reg_ra reg_zero)
        )
        (bench1_BAD2 regs0 mem0 pc0 regs9 mem9 pc9))))
